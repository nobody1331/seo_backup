...
<br>
<br>
<!-- <div id='carouselExampleControls container-fluid' class='carousel slide' data-ride='carousel' data-interval='5000' data-pause='hover'>
...
<section class="about" id="about" > 
		...
		<i style="font-size: 2rem;">About us</i>
		<p style="font-size: 1.5rem;">
Welcome to our Ayurveda pharmacy! We are dedicated to providing high-quality, natural healthcare products and services based on the ancient principles of Ayurveda...
		</p>
...
<!-- icon section -->
<section class="icons-container" id="featurs">
<div class="container">
<div class="row">
    <div class="col-sm-3 col-lg-2 col-6 box-class">
	...
	<i class="fas fa-tags"></i>
			<h3>easy to use</h3>
			<h6>easy use products</h6>
    </div>
    <div class="col-sm-3 col-lg-2 col-6 box-class">
	<i class="fas fa-gifts"></i>
			<h3>fast international delivery</h3>
			<h6>we provide fast international delivery for our customers</h6>
    </div>
	<div class="col-sm-3 col-lg-2 col-6 box-class">
 <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/e1/UPI-Logo-vector.svg/200px-UPI-Logo-vector.svg.png" alt="BHIM-UPI" style="height: 2rem;">
			<h3>Secure payment</h3>
			<h6>protected by BHIM UPI</h6>
    </div>
	<div class="col-sm-3 col-lg-2 col-6 box-class">
	<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/55/Emblem_of_India.svg/376px-Emblem_of_India.svg.png" alt="msme" style="height: 5rem;" >		
	        <h3>GMP Certified</h3>
			<h6>Certified by Good Manufacturing Process</h6>
    </div>
	<div class="col-sm-3 col-lg-2 col-6 box-class">
	<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/55/Emblem_of_India.svg/376px-Emblem_of_India.svg.png" alt="msme" style="height: 5rem;" >		
	        <h3>MSME Registered</h3>
			<h6>Working Since year 2005</h6>
    </div>
  </div>
</div>
</section>
...
<?php foreach($products as $product){   ?>
			<div class="box">
		<div class="image">
			<a href="https://shivaswasthyasansthan.in/product.php?id=<? echo $product['product_id']; ?>">
						<!-- xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx -->
						<? $arrimgxz = explode("+",$product['product_image']); ?>
		 <img class="d-block" src = "assets/imgs/<? echo "$arrimgxz[0]"; ?>" alt = "<? echo "$arrimgxz[0]"; ?>" >
		      <!-- xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx -->	
			<div class="form">
		...
		<h3><?php echo $product['product_name']; ?></h3>
			<div class="price"> &#x20b9;<?php echo ($product['product_price'] *  (100 - $product['product_special_offer'])/100 ); ?> <span> &#x20b9; <?php echo $product['product_price']; ?></span></div></a>
		</div>
	</div>
<?php  }   ?>
 </div>
...
<section class="review" id="review">
	...
	<div class="box-container">
		<div class="box">
			...
			<p> awesome products, i like those products so much</p>
			<div class="user">
				<img src="assets/imgs/test-overview.png" alt="">
				<div class="user-info">
					<h3>john</h3>
...
<section><h4>BLOG</h4></section>
<section><h4>VIDEO</h4></section>-->
