...
<body>
      ...
      <div id="heroCarousel" data-bs-interval="5000" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <?php  $i=0;
                            ...
                            $img='assets/img/slide/'.$row['image'];
                            $active='';
                            if ($i==0) {
                             $active='active';
                            }
  ...
  <!-- End Hero -->
  <section>
<div  style="background-color:#000; padding: 5px 20px; font-weight:bold;">
                <marquee class="marq" behavior="alternate" onmouseover="this.stop();" onmouseout="this.start();">
                 <a style="color:#fff;" href="#">Megamind Computer Institute, Azamgarh  || </a>
                
         <a href="#" style="color:#fff;"> Registered Indian Trust Act. 1882 Govt. Of India ||</a>
             <a href="#" style="color:#fff;">  An ISO 9001:2015 Certified Institute   </a>
  ...
  <main id="main">
    ...
    <section id="featured" class="featured">
      <div class="container">
        ...
        <div class="row"> 
          <div class="col-lg-4 text-center"><h3>Computer Lab</h3>
            <div class="icon-box" style="background-image:url(assets/img/b1.jpg); height: 250px;">

            </div>
          </div>
          <div class="col-lg-4 text-center"><h3>Wifi Campus</h3>
             <div class="icon-box" style="background-image:url(assets/img/b2.jpg);height: 250px;">
            </div>
          </div>
          <div class="col-lg-4 text-center"><h3>Job Oriented Course</h3>
             <div class="icon-box" style="background-image:url(assets/img/b3.png);height: 250px;">
            </div>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 content">
            <h3>Welcome To MEGAMIND COMPUTER INSTITUTE.</h3>
            <p class="fst-italic">
             Upgrade Your Career To New Technologies
            </p>
            <ul>
              <li><i class="bi bi-check-circle"></i> The satisfaction and success of our students says it all about us.</li>
              <li><i class="bi bi-check-circle"></i> Career courses, helping them to establish their careers in IT, Banking, Health, Teaching, Hospitality, Advertising, FMCG, Sales, Service or any other Govt. or private sector.</li>
              <li><i class="bi bi-check-circle"></i> We also guide our students with our expert career counselling and provide 100% placement.</li>
            </ul>
            <p>
              MEGAMIND COMPUTER INSTITUTE is the most trusted name in computer training and education. We in MEGAMIND teach all our students with utmost care and sincerity. We believe in conceptual learning and in-depth knowledge of technology. To ensure that, we provide high quality infrastructure and peaceful environment to our students.
            </p>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="icon-box">
              ...
              <h4><a href="course.php">Nielit Courses</a></h4>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
            <div class="icon-box">
              ...
              <h4><a href="course.php">Diploma Courses</a></h4>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0">
            <div class="icon-box">
              ...
              <h4><a href="course.php">Professional Course</a></h4>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
            <div class="icon-box">
              ...
              <h4><a href="course.php">Certificate Courses</a></h4>
              <p>Computer Typing, CCC, MS-Office, Certificate in electrical wiring etc.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
            <div class="icon-box">
              ...
              <h4><a href="course.php">Summer Vacational Courses</a></h4>
              <p>Graphic Design, Web Design, Programing Courses, Digital Markrting etc.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
            <div class="icon-box">
              ...
              <h4><a href="course.php">Short Term Courses</a></h4>
              <p>MS Excel Basic & Advance Excel, LibreOffice, C++ Language,  English Typing, Hindi Typing etc. </p>
            </div>
          </div>
    ...
    <section id="clients" class="clients">
      <div class="container">
        ...
        <div class="section-title">
          ...
          <p>Basic Computer | Advanced Excel | C | C++ | .Net | Java | Php & MySql | Android | Big Data Analytics & Hadoop | Python | Engg. College Project | Financial Accounting | GST | Web Design & Development | Graphic Designing | Multimedia | Hardware & Networking | Linux | Spoken English.</p>
        </div>

        <div class="clients-slider swiper">
          <div class="swiper-wrapper align-items-center">
            <div class="swiper-slide"><img src="assets/img/courses/typing.jpg" class="img-fluid" alt="<?=$title;?>"></div>
     <div class="swiper-slide"><img src="assets/img/courses/ccc.jpeg" class="img-fluid" alt="<?=$title;?>"></div>
      <div class="swiper-slide"><img src="assets/img/courses/olevel.jpg" class="img-fluid" alt="<?=$title;?>"></div>
     <div class="swiper-slide"><img src="assets/img/courses/ms.png" class="img-fluid" alt="<?=$title;?>"></div>
      <div class="swiper-slide"><img src="assets/img/courses/tally.jpg" class="img-fluid" alt="<?=$title;?>"></div>
    <div class="swiper-slide"><img src="assets/img/courses/dca.png" class="img-fluid" alt="<?=$title;?>"></div>
      <div class="swiper-slide"><img src="assets/img/courses/adca.png" class="img-fluid" alt="<?=$title;?>"></div>
          </div>
