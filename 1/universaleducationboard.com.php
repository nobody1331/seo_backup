...
<head>
    ...
    <title>Univarsal Education Board | Paramedical Council in UP, Bihar, Jharkhand </title>
    <meta name="description" content="Univarsal Education Board, Paramedical Council in UP, Bihar, Jharkhand an affiliated medical institution offering courses in the field of medical technology and paramedical science.">
    <meta name="keywords" content="Univarsal Education Board, Paramedical Council Bihar, Paramedical Council Uttar Pradesh, Paramedical Council Jharkhand">
...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-05JJW1WYXG"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-05JJW1WYXG');
</script>
</head>
...
<div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
     <img src="assets/images/banner-01.jpg" class="d-block w-100 img-fluid" alt="...">
    </div>
    <div class="carousel-item">
      <img src="assets/images/banner-02.jpg" class="d-block w-100 img-fluid" alt="...">
	  
	  
    </div>
    <div class="carousel-item">
      <img src="assets/images/banner-03.jpg" class="d-block w-100 img-fluid" alt="...">
    </div>
  </div>
    ...
    <span class="visually-hidden">Next</span>
                            ...
                            <div class="report-career-2-img-wrapper">
                                <div class="report-career-2-img-sm">
                                    <div class="report-career-2-img img-1">
                                        <img src="assets/images/career-sm-1.jpg" alt="">
                                    </div>
                                    <div class="report-career-2-img img-2">
                                        <img src="assets/images/career-sm-2.jpg" alt="">
                                    </div>
                                </div>
                                <div class="report-career-2-img-big">
                                    <img src="assets/images/career-big.jpg" alt="">
                                </div>
                            </div>
                            <!-- Report Career Image End -->
                        </div>
                        <div class="col-xl-7 col-lg-6 d-lg-flex align-items-center">
                            ...
                            <div class="report-career-content report-career-2-content">
                                <div class="section-title section-devider">
                                    <h2 class="title">Welcome to Universal Education Board</h2>
                                </div>
                                <p style="text-align:justify;">Above said council is a division regulating and governed the norms & objects of PMS & EHRDO of India is a registered organization under SR Act 21 of 1860,1882 (Working under Act 21 of 1854, 17 & 18 vict.-c-112 S. 20 et seq.) with its head office at Delhi is Generally called central board being central office to supervise the affiliated Institutions/colleges on all India bases. The council does not have any concern with any other council (Government-non-government) etc. All Diplomas/certificates etc. are awarded autonomously by the council. We offer some of the most professional courses such as BEMS and Dental Hygiene and in alternative medicine including BAMS (AM), MBBS (AM), and MD (AM).
</p>
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="headingThree">
                                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                                <p>Declaration of Result 1st year exam - 2020</p>
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="headingFour">
                                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                                                <p>Application are invited Only for Online Courses. Apply online</p>
                                                <span class="faq-button"><i class="fas fa-chevron-right"></i></span>
                                            </button>
                                        </h2>
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="headingSeven">
                                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven">
                                               <p>Application closed for Regular Program</p>
                                                <span class="faq-button"><i class="fas fa-chevron-right"></i></span>
                                            </button>
                                        </h2>
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="headingEight">
                                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseEight" aria-expanded="false" aria-controls="collapseEight">
                                               <p>Application for admission for session 2020-2021 available only for Online Courses</p>
                                                <span class="faq-button"><i class="fas fa-chevron-right"></i></span>
                                            </button>
                                        </h2>
                    ...
                    <!-- Faq Accordion End -->
                        ...
                        <div class="col-lg-5">
                            ...
                            <div class="contact-form">
                                <h4 class="title">Request Information</h4>
                                <form action="#">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <!-- Single Form Start -->
        ...
        <div class="section section-padding">
            <div class="container">
				...
				<div class="section-title section-devider text-center">
                        <h2 class="title">Choose From Our Top Courses</h2>
                    </div>
                <!-- Section Title End -->
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-sm-6">
                            ...
                            <div class="single-course">
                                ...
                                <div class="courses-image">
                                    <a href="naturopathy.php"><img src="assets/images/courses/naturopathy.jpg" alt="Courses"></a>
                                ...
                                <div class="courses-content">
                                    ...
                                    <h3 class="title"><a href="aturopathy.php">Naturopathy</a></h3>
                                </div>
                                <!-- Courses Content End -->
                                <!-- Courses Meta Start -->
                        ...
                        <div class="col-lg-3 col-sm-6">
                            ...
                            <div class="single-course">
                                <!-- Courses Image Start -->
                                <div class="courses-image">
                                    <a href="homeopathy.php"><img src="assets/images/courses/homeopathy.jpg" alt="Courses"></a>
                                ...
                                <div class="courses-content">
                                    ...
                                    <h3 class="title"><a href="homeopathy.php">Electro Homeopathy</a></h3>
                                </div>
                                <!-- Courses Content End -->
                                <!-- Courses Meta Start -->
                        ...
                        <div class="col-lg-3 col-sm-6">
                            ...
                            <div class="single-course">
                                <!-- Courses Image Start -->
                                <div class="courses-image">
                                    <a href="alternative.php"><img src="assets/images/courses/alternative.jpg" alt="Courses"></a>
                                ...
                                <div class="courses-content">
                                    ...
                                    <h3 class="title"><a href="alternative.php">Alternative</a></h3>
                                </div>
                                <!-- Courses Content End -->
                                <!-- Courses Meta Start -->
                        ...
                        <div class="col-lg-3 col-sm-6">
                            ...
                            <div class="single-course">
                                <!-- Courses Image Start -->
                                <div class="courses-image">
                                    <a href="ayurved.php"><img src="assets/images/courses/ayurved.jpg" alt="Courses"></a>
                                ...
                                <div class="courses-content">
                                    ...
                                    <h3 class="title"><a href="ayurved.php">Ayurved</a></h3>
                                </div>
                                <!-- Courses Content End -->
                                <!-- Courses Meta Start -->
						...
						<div class="col-lg-3 col-sm-6">
                            ...
                            <div class="single-course">
                                <!-- Courses Image Start -->
                                <div class="courses-image">
                                    <a href="unani.php"><img src="assets/images/courses/unani.jpg" alt="Courses"></a>
                                ...
                                <div class="courses-content">
                                    ...
                                    <h3 class="title"><a href="unani.php">Unani</a></h3>
                                </div>
                                <!-- Courses Content End -->
                                <!-- Courses Meta Start -->
						...
						<div class="col-lg-3 col-sm-6">
                            ...
                            <div class="single-course">
                                <!-- Courses Image Start -->
                                <div class="courses-image">
                                    <a href="veterinary.php"><img src="assets/images/courses/veterinary.jpg" alt="Courses"></a>
                                ...
                                <div class="courses-content">
                                    ...
                                    <h3 class="title"><a href="veterinary.php">Veterinary</a></h3>
                                </div>
                               

                            </div>
                            <!-- Single Courses End --></div>
						...
						<div class="col-lg-3 col-sm-6">
                            ...
                            <div class="single-course">
                                <!-- Courses Image Start -->
                                <div class="courses-image">
                                    <a href="yoga.php"><img src="assets/images/courses/yoga.jpg" alt="Courses"></a>
                                ...
                                <div class="courses-content">
                                    ...
                                    <h3 class="title"><a href="yoga.php">Yoga</a></h3>
                                </div>
						...
						<div class="col-lg-3 col-sm-6">
                            ...
                            <div class="single-course">
                                <!-- Courses Image Start -->
                                <div class="courses-image">
                                    <a href="paramedical.php"><img src="assets/images/courses/paramedical.jpg" alt="Courses"></a>
                                ...
                                <div class="courses-content">
                                    ...
                                    <h3 class="title"><a href="paramedical.php">Paramedical</a></h3>
                                </div>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="single-testimonial">
                                ...
                                <div class="testimonial-content color-1">
                                    <p>Good Institute for Paramedical as well as Yoga, DMLT, OT Technician & Naturopathy Courses with affordable fee structure.</p>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="single-testimonial">
                                ...
                                <div class="testimonial-content color-2">
                                    <p>Teachers are very qualified. The faculty are cooperative and generous. I really enjoy the college environment. I'm pursuing a DNYS course from the college. </p>
                                    <div class="testimonial-bottom">
                                        <div class="name-degree">
                                            <span class="name">
											Sheetal sharma</span>
                                            <span class="degree">Student </span>
                                        </div>
                                        <span><i class="flaticon-straight-quotes"></i></span>
                                    </div>
                                </div>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="single-testimonial">
                                ...
                                <div class="testimonial-content color-3">
                                    <p>My overall experience in the college was good. I have completed CMS & ED course from the college. The day spent on campus are one of the best days of my life.</p>
                                    <div class="testimonial-bottom">
                                        <div class="name-degree">
        ...
        <div class="section Brand-section">
            <div class="container">
                ...
                <div class="brand-wrapper section-padding text-center">
                    <h3 class="brand-title">Partnering with world's leading <span> universities and companies</span> </h3>
                    ...
                    <div class="brand-active">
                        <div class="swiper-container">
                            <div class="swiper-wrapper">
                                ...
                                <!-- Single Brand End -->
                                <!-- Single Brand Start -->
                                <div class="swiper-slide single-brand"><img src="assets/images/brand/brand-2.png" alt="Brand">
                                </div>
                                <!-- Single Brand End -->
                                <!-- Single Brand Start -->
                                <div class="swiper-slide single-brand">
