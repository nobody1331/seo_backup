...
<?php
	$msg = isset($_GET['msg']);
	$msg2 = isset($_GET['msg2']);
	$msg1 = isset($_GET['msg1']);
?>
<?php if($msg=='succ') {?>
<script type="text/javascript">
swal("Thanks for Apply!", "Thanking you in Anticipation", "success")
</script>
<?php } ?>
<?php if($msg1=='fail') {?>
<script type="text/javascript">
sweetAlert("Error!", "Please fill the all mandatory fields", "error");
</script>
<?php } ?>
<!-- Hero section -->
<section class="hero-section">
  <div class="hero-slider owl-carousel">
    <?php		
	$result1 = mysql_query("SELECT * FROM banner_tbl where status='active'");
	while($row1 = mysql_fetch_array($result1))
	{
	?>
    <div class="hs-item set-bg" data-setbg="admin_portal/web_image/banner/<?php echo $row1['photo']; ?>">
      <div class="container">
        <div class="row">
          <div class="col-xl-12 col-lg-12 text-white">
            <div class="bannertext">
              <h2><?php echo $row1['bantil']; ?></h2>
              <p><?php echo $row1['descrip']; ?></p>
              <a href="contact.php" class="site-btn sb-line">CONTACT US NOW</a> </div>
          </div>
        </div>
      </div>
    </div>
...
<section class="features-section">
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-md-3 p-0 feature">
        <div class="feature-inner">
          <div class="feature-icon"><i class="fa fa-truck" aria-hidden="true"></i></div>
          <h2>Free Shipping</h2>
        </div>
      </div>
    </div>
...
<!--------- About Part --------->
<div class="about_parthome">
  <div class="about_partleftborder">
    <div class="container">
      <div class="row">
        <div class="col-md-8">
          <div class="welcome-text">
            <h1>Welcome to <?php echo $row123['web_name'];?></h1>
            <?php echo substr($row123['aboutus'], 0, 550);?>
            <div class="know-more-wrapper11"> <a href="about.php">Read More <i class="fas fa-chevron-circle-right"></i></a> </div>
          </div>
        </div>
        <div class="col-md-4 homeaboutimg"> <img src="admin_portal/image/<?php echo $row123['about_photo']; ?>" alt=""> </div>
      </div>
    </div>
  </div>
</div>
...
<section class="top-letest-product-section">
  <div class="container">
    ...
    <div class="product-slider owl-carousel">
      <?php		
		$result2 = mysql_query("SELECT * FROM products_tbl where newpro='yes' && status='active'");
      ...
      <div class="product-item">
        <div class="pi-pic">
          ...
          <a href="product_detail.php?product_id=<?php echo $row3['sl_no'];?>"><img src="admin_portal/web_image/product/<?php echo $row3['photo']; ?>" alt=""></a>
          <div class="pi-links"> <a href="product_detail.php?product_id=<?php echo $row3['sl_no'];?>" class="add-card"><i class="fa fa-search"></i><span>VIEW DETAILS</span></a></div>
        </div>
        <div class="pi-text">
          <p><a href="product_detail.php?product_id=<?php echo $row3['sl_no'];?>"><?php echo $row3['proname']; ?></a></p>
        </div>
      </div>
      <?php
	   }
...
<section class="calltoaction">
  <div class="container">
    <div class="row">
      <div class="col-12 cta-2-area">
        <!-- Cta Content -->
        <div class="cta-content d-flex flex-wrap align-items-center justify-content-between">
          <div class="cta-text">
            <h4>Are you looking for any product or query? Get in touch with us.</h4>
          </div>
          <div class="cta-btn"> <a href="contact.php" class="btn credit-btn">Contact Us</a> </div>
        </div>
      </div>
    </div>
  </div>
...
<section class="testimonial-section">
  <div class="container">
    <div class="testimonial-slider owl-carousel">
      <?php		
		$result411 = mysql_query("SELECT * FROM testimonials_tbl where status='active' order by sl_no desc");
      ...
      <div class="ts-item">
        <div class="row">
          <div class="col-md-3">
            <div class="ts-author-pic set-bg" data-setbg="admin_portal/web_image/testimonials/<?php echo $row411['photo']; ?>"></div>
          </div>
          <div class="col-md-9 ts-text"> <?php echo $row411['descrip']; ?>
            <h5><?php echo $row411['name']; ?></h5>
            <span><?php echo $row411['detail']; ?></span> </div>
        </div>
      </div>
      <?php
	   }
