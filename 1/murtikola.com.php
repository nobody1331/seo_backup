...
.area {
  ...
  text-shadow: 0px 0px 3px #C5CAE9;
  margin-top:-40px;
  margin-bottom:-15px;
}
@keyframes blur {
  from {
    text-shadow:0px 0px 10px #C5CAE9,
      0px 0px 10px #C5CAE9, 
      0px 0px 20px #C5CAE9,
      0px 0px 20px #C5CAE9,
      0px 0px 40px #C5CAE9,
...
<!--<div class="area">Wholesale facility is also available here<br>Please contact at 9434054758</div>-->

<section class="page-section">
    <div class="container">
        <h2 class="section-title"><span>All Categories</span></h2><br>
				...
				<div class="thumbnail no-border no-padding">
				    <div class="media">
				        <a  href="category.php?id=<?php echo htmlentities($row['id']);?>">
				            <img src="admin/pics/<?php echo htmlentities($row['img_name']);?>" id="qq">
				        </a>
				    </div>
				    <div class="caption text-center">
				        <h4 class="caption-title category-caption" style="line-height:10px;">
				        	<b><a href="category.php?id=<?php echo htmlentities($row['id']);?>"><?php echo htmlentities($row['categoryName']);?></a></b>
				        </h4>
				    </div>
				</div>
<?php } ?>
...
<?php include "offer-section.php"; ?>
<?php checkInformation(); ?>
       <!-- <section class="page-section">
            <div class="container">
                <h2 class="section-title"><span>Categories</span></h2>
                <div class="partners-carousel">
                    <div class="owl-carousel" id="partners">
                       <?php echo fetchCatgMenu() ; ?>
                    </div>
                </div>
            </div>
        </section>  -->
<?php include "best-selling.php"; ?>
<div class="container" align="center">
<button id="filterButton" data-toggle="collapse" data-target="#demo" class="btn btn-primary"><i class="fa fa-filter"></i> Filters</button>
</div>
         <section class="page-section">
            <div class="container">
            <div class="row collapse" id="demo">
			<form method="POST"  action="loadData.php" name="filter" id="filter">
                <!-- Product Filter -->
				<div class="col-md-3 col-sm-3 col-xs-12">
                   	<div class="widget shop-categories" style="max-height:320px; min-height:320px; overflow-y:auto;">
                    ...
                    <div class="widget widget-filter-price">
                            ...
                            <div class="widget-content">
                             <label for="price-min">Min Price:</label>
								<input class="form-control" type="number" name="price-min" id="price-min"  min="1" >
								<label for="price-max">Max Price:</label>
								<input class="form-control"type="number" name="price-max" id="price-max"  min="1" >
							  <label for="price-min">&nbsp;</label>
							<button type="submit" class="btn btn-theme form-control">Filter</button>
							</div>
                    </div>
                </div>
			</form>
	...
	<!-- PAGE -->
        <section class="page-section" >
            <div class="container">
               <h2 align="center" style="color:black;">Top Products </h2><br/>
				<div class="tab-content" id="loadData">
				</div>
				<div class="row" id="theTarget">
				<div class="col-md-12" id="loading-image">
				</div>
				</div>
				<div id="message" style="color: red;font-size:25px;"></div>
            </div>
        </section>
<style>
.modal-header {
...
<div class="modal fade" id="reviewModal"  role="dialog"  aria-hidden="true">
  ...
  <div class="modal-dialog"   style="padding-top:2%;width:350px;margin:auto;max-width: 100%;">
    <div class="modal-content">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title"></h4>
      </div>
      <div class="modal-body review-description">
       <div class="container-fluid">
		<div class="row" >
		<div class="col-xs-12" id="review">
		<form method="POST" action="feedback.php" id="review-form">
		<p align="center" style="font-size:16px;color:black;">How was your  experience with us ?</p>
		<span id="transId"></span>  
		<input type="hidden" id="tr_id" name="tr_id">
		<span id="orderDate"></span>
	   <ul class="nav nav-tabs">
		
		<li class="active"><a data-toggle="tab" href="#menu1">Ok</a></li>
		<li><a data-toggle="tab" href="#menu2">Good</a></li>
		<li><a data-toggle="tab" href="#menu3">Very Good</a></li>
	  </ul>
	  <div class="tab-content">
		  <div id="home" class="tab-pane fade in active">
			...
			<div id="menu2" class="tab-pane fade">
			  <h3>Good</h3>
			  <p>What do you want more from us?</p>
			</div>
			<div id="menu3" class="tab-pane fade">
			  <h3>Very Good</h3>
			  <p>What makes you to feel it ?</p>
			</div>
	  </div>
	...
	<div class="product-rating clearfix">
		<div class="rating">
		  ...
		  <span value="5" id="star5" onclick="rating('star5')" class="star"></span>
		  <span value="4" id="star4" onclick="rating('star4')" class="star"></span>
		  <span value="3" id="star3" onclick="rating('star3')" class="star"></span>
		  <span value="2" id="star2" onclick="rating('star2')" class="star"></span>
		  <span value="1" id="star1" onclick="rating('star1')" class="star"></span>
		  <label> : Rating  </label>
		</div>
     </div>
	  <label>Leave a comment</label>
	  <textarea name="feedback" id="feedback" class="form-control"></textarea><br/>
...
<div class="modal fade" id="exampleModalCenter"  role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" id="g" style="margin:auto;padding-top:2%;">
      <div class="modal-content" >
      
        <div class="modal-body itemDesceiption" id="modalBody" >
           <div class="container-fluid">
		    <button type="button" class="close" data-dismiss="modal">&times;</button>
			   <div class="row product-single" >
			 <section id="pase" class="page-section" > 
			
				 <div class="col-md-4" id="quickViewSlider"  >
	                       <div class="owl-carousel owl-theme" id="slider">
							<img  id="img1" class="qimage" style="width:281px ; height:380px ;" src="assets/img/preview/shop/product-1.jpg" alt=""/>
							<img id="img2" class="qimage" style="width:281px ; height:380px ;" src="assets/img/preview/shop/product-2.jpg" alt=""/>
				</div>    
                  </div>
				  <button class="btn btn-sm btn-success myBtn"> <i class="fa fa-angle-down" aria-hidden="true"></i> </button>
				   
				   <div class="col-md-8" style="padding:5%;padding-top:15px;">
                        <div class="project-overview" id="productTitle"></div>
						 <form 	method="POST"   action="addToCart.php" name="quick" id="quick" class="row variable">
						 <div class="form-group" style="margin-top:0px;">
							<input type="hidden" name="itemId" id="itemId">
							<input type="hidden" name="discountVal" id="discountVal">
							<input type="hidden" name="colorStatus" id="colorStatus" value="<?php echo checkForColor(($_GET['id'])) ;?>">
							<div class="col-sm-6 col-md-6 col-xs-12">
							<div id="price" style="font-size:25px;"> </div>
							<div id="price1" style="font-size:25px;"> </div>
							<span><small>MRP incl. of all taxes </small></span></small><br>
							<div class="col-sm-9" style="margin-top: -2px; margin-left: -13px;">
								<span>Wholesale Price<span id="wholesale_caption"></span></span>
							</div>
							<div class="col-sm-3" style="margin-top: -2px;">
								<div id="wholesale_price" style="font-size:15px;"></div>
							</div>
							<div class="col-sm-9" style="margin-top: -2px; margin-left: -13px;">
								<span>Minimum Quantity<span id="wholesale_caption"></span></span>
							</div>
							<div class="col-sm-3" style="margin-top: -2px;">
								<div id="minimum_quantity" style="font-size:15px;"></div>
							</div>
							</div>
							<div class="col-sm-6 col-md-6 col-xs-12 form-group form-inline">
								<ul>
									<li>Brand : <label id="brand"></label></li>
									<li>Category : <label id="style"></label></li>
									<li>Color : <label id="setNo"></label></li>
								</ul>
							</div>	
                          </div><br><br>
                          <div class="project-details">
                            ...
                            <dl class="dl-horizontal">
							 <div class="widget-content">
								<div class="form-group panel-group payments-options">
								...
								<div class="form-group selectpicker-wrapper" id="colorDiv">
                                    <label for="exampleSelect2" >Color </label>
									<div class="widget widget-colors">
										<div class="widget-content">
											<div class="form-group">
												<label for="exampleSelect2">Selected Color:</label> 
												<div id="selectedColor" style="border:1px solid black;height:25px;width:25px; padding-right:0px;"></div>
												<input type="hidden" name="color" id="color" >
												<input type="hidden" name="colorId" id="colorId" >
												<input type="hidden" name="colorSet" id="colorSet">
											...
											<div class="divider"></div> 
											 <label for="exampleSelect2">Select Color</label>
										   <ul id="colors-option">
							
											</ul>
											<p id="colorText" style="color:red;"></p>
									  	</div>
									</div>                                          
                                </div>
							<!--	<div class="buttons">
								...
								<div class="row" id="sizeDiv" style="display:none;">
									<div class="col-xs-12">
									<div class="form-group">
									<label>Size:</label>
										<select class="form-control" name="size" id="size" onchange="pickPrice()"></select>
									</div>
									</div>
								</div>
								<div class="row">
									<div class="col-sm-6 col-md-6 col-xs-12" id="addButtons">
									<div class="form-group">
									...
									<div class="buttons">
									<div class="quantity">
										<button type="button" id="minus" class="btn"><i class="fa fa-minus"></i></button>
										<input class="form-control qty" style="width:55px !important;" type="number" step="1" min="1" name="quantity" id="quantity" value="1" title="Qty">
										<button type="button" id="plus" class="btn"><i class="fa fa-plus"></i></button>
										<!--<span><label style="margin-top:12%;margin-left:5px;" >No of Pieces :</label ><label id="piece"></label></span> -->
									...
									<div class="form-group">
									<button type="submit" name="addToCart"   id="addToCart" class="btn btn-success btn-lg btn-block btn-icon-left"><i class="fa fa-shopping-cart"></i>Add to Cart </button>
									</div>
									<div class="form-group">
									...
									<div class="col-sm-6 col-md-6 col-xs-12" id="notifyOption" style="display:none;">
									<form method="POST" name="notifyForm" id="notifyForm" action="notify.php">
									<div class="input-group">	
										
										<span class="input-group-addon"> +91</span>
										<input type="text" class="form-control" name="mobile" id="mobile"  minlength="10" maxlength="10" placeholder="Mobile No" required>
										<input type="hidden" class="form-control" name="notifyProduct" id="notifyProduct">
										
									</div><br/>
									<div class="form-group">
									<button type="submit" name="notify" id="notify" class="btn btn-primary btn-lg btn-block">Notify Me</button>
									</div>
									</form>
									</div>
								</div>
