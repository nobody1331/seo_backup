...
?>
    ...
    <!-- Banner-area -->
    <div class="banner-area owl-carousel"> 
    
    <?php
        $sql="select * from websitehomeslider";
        $data=$Site_obj->fetch($sql);
        foreach($data as $banner){
    ?>
    
        <div class="item">
            <div class="banner-images">
                <img src="<?=$banner['picPath']?>" alt="">
            </div>
            <div class="container">
                <div class="banner-heading text-left">
                    <h1 class="wow fadeInDown" data-wow-duration="2s"><?=$banner['tag1']?></h1>
                    
                    <h2 class="wow fadeInDown" data-wow-duration="2.2s" style="color:white;">For More Details Contact: 469 922-5955</h2>
                    
                    <p class="wow fadeInDown" data-wow-duration="3s"><?=$banner['tag2']?></p>
                    <a class="theme-btn wow fadeInDown" data-wow-duration="3.20s" href="course.php">Learn More</a>
                    <a class="theme-btn btn-two wow fadeInDown" data-wow-duration="3.20s" href="contact.php">Contact Us</a>
                </div>
            </div>
        </div>
                        ...
                        <div class="form-text-left">
                            <div class="form-text-img">
                                <svg width="100" height="78" viewBox="0 0 100 78" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M32.3817 43.6936C28.3129 41.6343 23.1913 41.516 18.6365 40.7964C14.3962 40.1242 6.66842 37.1845 3.58111 33.9986C-1.75498 28.4931 -1.43577 16.4691 6.6303 12.6299C15.8827 8.22267 27.5078 12.2701 37.5368 13.5767C53.0114 15.598 56.337 3.72076 71.3876 1.68046C77.143 0.899369 85.3567 2.61303 88.1773 8.43569C91.7553 15.83 87.01 24.3226 92.3747 31.3334C94.3805 33.956 107.368 44.9906 94.1136 49.3363C89.3683 50.8938 84.4992 51.9021 79.649 53.0524C74.98 54.1602 70.4443 55.4856 66.2516 57.8431C60.6583 60.9864 54.5074 65.6777 48.066 62.5107C39.7808 58.4301 39.938 47.5185 32.3817 43.6936Z" fill="#FFA8BF"/>
                                    <path d="M11.9569 34.6756C-4.03712 59.0219 26.5215 70.227 45.8506 70.227C64.8557 70.227 86.3382 63.1025 86.3382 41.2084C86.3382 -15.1531 39.4139 -7.11498 11.9569 34.6756Z" fill="#E81D4F"/>
                                    <path d="M32.9106 6.973C32.9106 8.55412 31.2192 9.837 29.1277 9.837C27.0409 9.837 25.3447 8.55412 25.3447 6.973C25.3447 5.39189 27.0361 4.10901 29.1277 4.10901C31.2192 4.10901 32.9106 5.39189 32.9106 6.973Z" fill="#E81D4F"/>
                                    <path d="M37.5939 1.42966C37.5939 2.22021 36.8698 2.85928 35.9741 2.85928C35.0784 2.85928 34.3542 2.22021 34.3542 1.42966C34.3542 0.639101 35.0784 2.59397e-05 35.9741 2.59397e-05C36.865 -0.00470793 37.5939 0.639101 37.5939 1.42966Z" fill="#E81D4F"/>
                                    <path d="M63.9743 78.0001C65.7135 78.0001 67.1235 76.5992 67.1235 74.871C67.1235 73.1429 65.7135 71.7419 63.9743 71.7419C62.235 71.7419 60.825 73.1429 60.825 74.871C60.825 76.5992 62.235 78.0001 63.9743 78.0001Z" fill="#E81D4F"/>
                                    <path d="M89.8114 59.0409C89.8114 60.3758 88.6013 61.4551 87.11 61.4551C85.6188 61.4551 84.4086 60.3758 84.4086 59.0409C84.4086 57.7059 85.6188 56.6266 87.11 56.6266C88.6013 56.6266 89.8114 57.7059 89.8114 59.0409Z" fill="#E81D4F"/>
                                    <path d="M83.1508 62.4399C83.1508 62.9322 82.6268 63.3346 81.9788 63.3346C81.3309 63.3346 80.8068 62.9322 80.8068 62.4399C80.8068 61.9475 81.3309 61.5452 81.9788 61.5452C82.6268 61.5452 83.1508 61.9428 83.1508 62.4399Z" fill="#E81D4F"/>
                                </svg>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-left">
                                        ...
                                        <input class="your-name" type="text" name="name" placeholder="Your Name">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-left">
                                        <div class="input-group">
                                            ...
                                            <input type="email" name="email" placeholder="Your Email" class="mail-too">
                                           
                                        </div>
                                        <div class="input-group">
                                            
                                               <input type="text" name="message" placeholder="Message" class="mail-too">
                                    
                                        </div>
                                       
                                        
                                        <button class="theme-btn" type="submit" name="enquiry">Book Now</button>
    ...
    <section class="features-area"> 
        <div class="container">
            <div class="title text-center">
                ...
                <p>We have been providing an excellent start to our students’ driving future with dedication and a proper driving program like none. Experience freedom of driving and professionalism with our driving program. </p>
            </div>
            <div class="row">
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-duration="1.30s">
                    <div class="feature-items text-center">
                        ...
                        <?php
                            $sql="select * from information where id=49";
                            $data=$Site_obj->single_fetch($sql);
                        ?>
                ...
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-duration="1.50s">
                    <div class="feature-items text-center">
                        <div class="feature-icon">
                          ...
                          <?php
                            $sql="select * from information where id=50";
                            $data=$Site_obj->single_fetch($sql);
                        ?>
                        <div class="feature-text">
                            <h5><?=$data['name']?></h5>
                ...
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-duration="2.20s">
                    <div class="feature-items text-center">
                        <div class="feature-icon">
                            ...
                            <span class="shape-two">
                                ...
                                <path d="M56.0687 2.12616C56.0687 3.30186 54.9886 4.25227 53.6528 4.25227C52.3169 4.25227 51.2368 3.30186 51.2368 2.12616C51.2368 0.950457 52.3169 3.8577e-05 53.6528 3.8577e-05C54.9815 -0.00700154 56.0687 0.950457 56.0687 2.12616Z" fill="#E81D4F"/>
                                <path d="M95.4131 116C98.0071 116 100.11 113.917 100.11 111.347C100.11 108.776 98.0071 106.693 95.4131 106.693C92.8191 106.693 90.7162 108.776 90.7162 111.347C90.7162 113.917 92.8191 116 95.4131 116Z" fill="#E81D4F"/>
                                <path d="M133.947 87.8043C133.947 89.7896 132.143 91.3948 129.918 91.3948C127.694 91.3948 125.889 89.7896 125.889 87.8043C125.889 85.819 127.694 84.2139 129.918 84.2139C132.143 84.2139 133.947 85.819 133.94787.8043Z" fill="#E81D4F"/>
                                <path d="M124.014 92.8593C124.014 93.5914 123.232 94.1898 122.266 94.1898C121.299 94.1898 120.518 93.5914 120.518 92.8593C120.518 92.1271 121.299 91.5287 122.266 91.5287C123.232 91.5287 124.014 92.1201 124.014 92.8593Z" fill="#E81D4F"/>
                                </svg>
                            </span>
                        </div>
                          <?php
                            $sql="select * from information where id=51";
                            $data=$Site_obj->single_fetch($sql);
                        ?>
                        <div class="feature-text">
                            <h5><?=$data['name']?></h5>
                ...
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-duration="2.50s">
                    <div class="feature-items text-center">
                        <div class="feature-icon">
                           ...
                           <?php
                            $sql="select * from information where id=52";
                            $data=$Site_obj->single_fetch($sql);
                        ?>
                        <div class="feature-text">
                            <h5><?=$data['name']?></h5>
            ...
            <div class="row">
                <div class="col-lg-6 wow fadeInLeftBig" data-wow-duration="1.30s">
                    <div class="about-text-area">
                        ...
                        <?php
                            $sql="select * from information where id=13";
                            $data=$Site_obj->single_fetch($sql);
                        ?>
                        ...
                        <a class="theme-btn" href="about.php">About More</a>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="about-image-area">
                           ...
                           <?php
                            $sql="select * from information where id=11";
                            $data=$Site_obj->single_fetch($sql);
                        ?>
                        
                        <div >
                              
                            <img src="<?=$data['data']?>" alt="" style="padding:5px;width:100%;height:600px;">
    ...
    <!-- Funfact-area -->
    <section class="funfact-area" style="padding-top:0px !important;">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 wow fadeInLeftBig" data-wow-duration="1.30s">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="funfact-item text-center">
                                <span class="completed"><svg width="48" height="50" viewBox="0 0 48 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M5.51062 40.9787V5.46383H34.1936V35.2904L39.6585 30.7766V2.73191C39.6585 1.2234 38.4361 0 36.9276 0H2.7787C1.27019 0 0.0478516 1.2234 0.0478516 2.73191V43.7096C0.0478516 45.2181 1.27019 46.4415 2.7787 46.4415H26.617L22.7553 40.9787H5.51062Z" fill="#E81D4F"/>
                                    <path d="M47.5245 29.3713C47.0213 28.8968 46.2479 28.8745 45.7181 29.3106L33.1884 39.6659L24.8384 34.6564C24.2841 34.3245 23.5745 34.4234 23.133 34.9C22.6947 35.3723 22.6469 36.0883 23.0203 36.6159L32.0692 49.4213C32.3224 49.7798 32.7341 49.9947 33.1724 49.9989C33.1767 49.9989 33.1809 49.9989 33.1852 49.9989C33.6192 49.9989 34.0288 49.7936 34.2862 49.4404L47.6905 31.1713C48.0947 30.617 48.0256 29.8457 47.5245 29.3713Z" fill="#E81D4F"/>
                                    <path d="M28.0489 9.56171H11.6564C10.1479 9.56171 8.92554 10.7851 8.92554 12.2936C8.92554 13.8021 10.1479 15.0255 11.6564 15.0255H28.0479C29.5564 15.0255 30.7777 13.8021 30.7777 12.2936C30.7777 10.7851 29.5575 9.56171 28.0489 9.56171Z" fill="#E81D4F"/>
                                    <path d="M28.0489 17.7564H11.6564C10.1479 17.7564 8.92554 18.9798 8.92554 20.4883C8.92554 21.9968 10.1479 23.2202 11.6564 23.2202H28.0479C29.5564 23.2202 30.7777 21.9979 30.7777 20.4883C30.7809 18.9798 29.5575 17.7564 28.0489 17.7564Z" fill="#E81D4F"/>
                                    <path d="M28.0489 25.9521H11.6564C10.1479 25.9521 8.92554 27.1755 8.92554 28.684C8.92554 30.1925 10.1479 31.4159 11.6564 31.4159H28.0479C29.5564 31.4159 30.7777 30.1925 30.7777 28.684C30.7809 27.1755 29.5575 25.9521 28.0489 25.9521Z" fill="#E81D4F"/>
                                    </svg>
                                    </span>
                        ...
                        <div class="col-sm-6">
                            <div class="funfact-item items-two text-center">
                ...
                <div class="col-lg-6 wow fadeInRightBig" data-wow-duration="1.30s">
                    <div class="funfact-text-area">
                        ...
                        <p>With our 15 years of experience as trained professionals, we have the expertise in teaching students how to drive safely and responsibly. Allow yourself to be guided by the best and expert trainers. We have completed more than 20k courses with 2.5k students from all around the US. </p>
                        <a class="theme-btn" href="course.php">Learn More</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="courses-area">
        <div class="container">
            <div class="title">
                ...
                <p class="m-0">With trust and reputation gained from more than 20k students, we have come to understand the driving needs of people and have thus developed a few popular courses. </p>
            </div>
                ...
                <div class="item"> 
                    <div class="course-item"> 
                        ...
                        <div class="courses-img-heading">
                            ...
                            <p><?=substr($service['content'],0,200)?></p>
                            <a class="theme-btn" href="course-detail.php?id=<?=$service['id']?>">View Course</a>
                        </div>
                    </div>
                </div>
    ...
    <!-- driving-area -->
    <section class="driving-area">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 wow fadeInLeftBig" data-wow-duration="1.30s">
                    <div class="driving-text">
                        <h1>Start Learning to Drive Today</h1>
                        <p>With specialized training programs and private classes meant just to focus on your specific needs start learning how to drive safely and responsibly, today. Contact us: </p>
                ...
                <div class="col-lg-6 wow fadeInRightBig" data-wow-duration="1.30s">
                    <div class="driving-img">
                        <img src="images/driving-h1.png" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="testimonial-area">
        <div class="container">
            <div class="row">
                <div class="col-lg-7 wow fadeInLeftBig" data-wow-duration="1.30s">
                    <div class="testimonial-item text-left">
                        ...
                        <div class="testimonal-images">
                            <img src="images/driving-h1.png" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-lg-5 wow fadeInRightBig" data-wow-duration="1.30s">
                    <div class="testimonial-mamber owl-carousel">
                        ...
                        <div class="item">
                            <div class="testimonial-peragraph">
                                <span><svg width="20" height="15" viewBox="0 0 20 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M0