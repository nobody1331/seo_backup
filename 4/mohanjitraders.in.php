...
<head>
        ...
        <title>Mohan ji</title>
        <meta name="description" content="">
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <!-- Favicon -->
        <link rel="shortcut icon" type="image/x-icon" href="img/logo.png">
        <!-- Material Design Iconic Font-V2.2.0 -->
        <link rel="stylesheet" href="css1/material-design-iconic-font.min.css">
        <!-- Font Awesome -->
        <link rel="stylesheet" href="css1/font-awesome.min.css">
        <!-- Font Awesome Stars-->
        <link rel="stylesheet" href="css1/fontawesome-stars.css">
        <!-- Meanmenu CSS -->
        <link rel="stylesheet" href="css1/meanmenu.css">
        <!-- owl carousel CSS -->
        ...
        <!-- Helper CSS -->
        <link rel="stylesheet" href="css1/helper.css">
        <!-- Main Style CSS -->
...
<?php// include("//includes/Begin-header.php");?>
                <!-- Header Top Area End Here -->
				
				
                <!-- Begin Header Middle Area -->

<!-- add2 --><?php include("includes/Begin2-header.php");?>
...
<!--add2-->
		...
		<?php include("includes/Begin3-header.php");?>
	<br>
...
<?php include("includes/product4-header.php");?>
 <!--
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 text-center">
                            <div class="single-banner pb-xs-30">
                                <a href="#">
                                    <img src="images/banner/banner.jpg" alt="Li's Static Banner">
                                </a>
                            </div>
                        </div>
                                            ...
                                            <div class="product_desc">
                                                <div class="product_desc_info"><div class="product-review">
                                                        <h5 class="manufacturer">
                                                           <a href="shop-left-sidebar.html" onclick="if(alert(' Under WorkingIt is coming soon!')) window.location='evalhome.php';else return false;"><?php echo htmlentities($row['productCompany']);?></a>
                                                        </h5>
													...
													<a class="product_name" href="single-product.html" onclick="if(alert(' Under WorkingIt is coming soon!')) window.location='evalhome.php';else return false;"><?php echo htmlentities($row['productName']);?></a></h4>
                                                    <div class="price-box">
                                                        <span class="new-price new-price-2"><?php echo htmlentities($row['productPrice']);?></span>
                                                        <span class="old-price"><?php echo htmlentities($row['productPriceBeforeDiscount']);?></span>
                                                        <span class="discount-percentage">-7%</span>
                                                    </div>
                                                </div>
                                                <div class="add-actions">
                                                    <ul class="add-actions-link">
                                                        <li class="add-cart active"><a href="#" onclick="if(alert(' Under WorkingIt is coming soon!')) window.location='evalhome.php';else return false;">Add to cart</a></li>
                                                        <li><a class="links-details" href="#" onclick="if(alert(' Under WorkingIt is coming soon!')) window.location='evalhome.php';else return false;"><i class="fa fa-heart-o"></i></a></li>
                                                <li><a class="quick-view" href="product-details1.php?pid=<?php echo htmlentities($row['id']);?>"><i class="fa fa-eye"></i></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-lg-3 col-md-6">
                            ...
                            <div class="limupa-counter gray-bg">
                                <div class="counter-img">
                                    <img src="https://static.thenounproject.com/png/1264429-200.png"  Width="50" alt="">
                                </div>
                                <div class="counter-info">
                                    <div class="counter-number">
                        ...
                        <div class="col-lg-3 col-md-6">
                            ...
                            <div class="limupa-counter white-smoke-bg">
                                <div class="counter-img">
                                    <img src="https://static.thenounproject.com/png/3631626-200.png" width="50" alt="">
                                </div>
                                <div class="counter-info">
                                    <div class="counter-number">
                        ...
                        <div class="col-lg-3 col-md-6">
                            ...
                            <div class="limupa-counter gray-bg">
                                ...
                                <div class="counter-info">
                                    <div class="counter-number">
                                        <h3 class="counter">5069</h3>
                                    </div>
                                    <div class="counter-text">
                                        <span>COMPLETE ONLINE ODERS</span>
                                    </div>
                                </div>
                            </div>
                            <!-- limupa Counter Area End Here -->
...
<!-- add-->
        ...
        <!-- Ajax Mail js -->
        <script src="js1/ajax-mail.js"></script>
        <!-- Meanmenu js -->
        <script src="js1/jquery.meanmenu.min.js"></script>
        <!-- Wow.min js -->
        ...
        <!-- Mixitup js -->
        <script src="js1/jquery.mixitup.min.js"></script>
        <!-- Countdown -->
        ...
        <!-- Barrating -->
        <script src="js1/jquery.barrating.min.js"></script>
        <!-- Jquery-ui -->
        ...
        <!-- ScrollUp js -->
        <script src="js1/scrollUp.min.js"></script>
        <!-- Main/Activator js -->
