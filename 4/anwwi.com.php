...
<?php include "header.php";?>
		...
		<div class="edu2_main_bn_wrap">
			...
			<?php 
				$query="select * from tbl_slider where is_deleted ='N'";
				$result = mysqli_query($conn,$query);
				while($data = mysqli_fetch_array($result)){
			?>
				<div class="item">
					<figure>
						<img src="admin/assets/images/slider/<?php echo $data['sliderimage'];?>" alt=""/>
						<figcaption>
							<span><?php echo $data['heading1'];?></span>
							<h2><?php echo $data['heading2'];?></h2>
							<p><?php echo $data['heading3'];?></p>
						</figcaption>
					</figure>
				</div>
				<?php } ?>	
		...
		<div class="kf_content_wrap">
			...
			<?php 
				$wQuery = "select * from tbl_home where is_deleted ='N'";
				$wresult = mysqli_query($conn,$wQuery);
				$wdata = mysqli_fetch_array($wresult);
			
			?>
		<!--	<section class="kf_edu2_intro_wrap" style="margin-top: 56px;" >
				<div class="kf_intro_des_wrap1">
					<img src="admin/assets/images/home/<?php echo $wdata['welcomeimge'];?>" alt="">
				</div>
				<div class="kf_intro_des_wrap">
					<div class="col-md-12">
						<div class="kf_edu2_heading2">
							<h3>Welcome to Academy of <br> Nanotechnology and Waste Water Innovations</h3>
						</div>
					</div>
					...
					<div class="kf_edu2_heading2">
						<div class="kf_intro_des_caption">
							...
							<p style="text-align: justify;padding-left: 10px;padding-right: 10px;"><?php echo $wdata['welcomenotes'];?></p>
							...
							<div class="col-md-12">
									...
									<div role="tabpanel" class="tab-pane fade in active" id="all">
										...
										<div class="row margin-bottom">
											...
											<?php 
												$cquery ="select * from tbl_course where is_deleted ='N' limit 3";
                                            ...
                                            <div class="col-md-4">
                                                <div class="edu2_cur_wrap">
                                                    <figure>
                                                        <img src="admin/assets/images/course/<?php echo $cdata['courseimge'];?>" alt="" style="width:358px; height:235px;">
                                                        <figcaption><a href="courses-detail.php?id=<?php echo $cdata['id'];?>">See More</a></figcaption>
                                                    </figure>
                                                    <div class="edu2_cur_des">
                                                      
                                                        <h5><a href="courses-detail.php?id=<?php echo $cdata['id'];?>"><?php echo $cdata['coursetitle'];?></a></h5>
                                                        
                                                        <p><?php echo $str = substr($cdata['coursedescription'], 0, 150);?>..</p>
                                                    </div>
                                        ...
                                        <div class="view-all">
                                        	<a class="btn-3" href="our-courses.php">View All Courses</a>
                                        </div>
									</div>
			...
			<section class="kf_edu_price_bg">
				<div class="container">
					...
					<div class="edu2_pricing_wrap">
						<div class="row">
						<?php 
							$pquery ="select * from tbl_planspricing where is_deleted ='N' limit 3";
						...
						?>
							<div class="col-md-4">
								...
								<div class="edu2_pricing_des">
									<h4><?php echo $pdata['title'];?></h4>
									<div class="pckg-price"><strong><sup></sup>&#x20AC;<?php echo $pdata['price'];?></strong><h3><?php echo $pdata['validfor'];?></h3></div>
									<ul>
										<li><p style="color:#2f2f2f;padding-left: 10px;padding-right: 10px;text-align: justify;"><b><?php echo $str = substr($pdata['description'], 0, 200);?></b></p></li>
									</ul>
									
									<ul style="height:160px;">
										<li><p style="color:#2f2f2f;padding-left: 10px;padding-right: 10px;text-align: justify;"><b><?php echo $pdata['other'];?></b></p></li>
									</ul>
									<button class="subscribe">Select</button>
								</div>
