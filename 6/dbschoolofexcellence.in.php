...
?>
п»ї<?php require_once('header.php'); ?>
...
?>
  ...
  <?php
			$statement = $pdo->prepare("SELECT * FROM tbl_slider WHERE status=? ORDER BY id");
...
<section class="flash"><marquee class="pt-10"><h4>ONLINE REGISTRATIONS FOR LKG IS CLOSED FOR THE ACADEMIC YEAR 2023-24
 <!--and ends on 05.01.2023 by 8 pm <a href="#" target="_blank">- Click Here</a>  -->|  Teachers Wanted. <a href="https://dbschoolofexcellence.in/page/parent-login" target="_blank">- Click Here</a></h4>
</marquee> </section>   


<!-- <section class="flash"><marquee class="pt-10"><h4>Kindly check the Parent Login for the December Schedule and Periodic Exam III Portions and Timetable.  |  Teachers Wanted. <a href="https://dbschoolofexcellence.in/page/parent-login" target="_blank">- Click Here</a></h4>
</marquee> </section>  -->  
 <br><br>
...
<div class="container">
	...
	<div class="btn-part wow fadeInUp" data-wow-delay="300ms" data-wow-duration="2000ms">
                                <a class="readon2 lkg" href="#">ONLINE REGISTRATIONS FOR LKG IS CLOSED FOR THE ACADEMIC YEAR 2023-24
 </a>
                            </div>
	</div>
...
<?php if($home_status_about == 1): ?>
         ...
         <!-- <div id="rs-about" class="rs-about style1 pt-100 pb-100 md-pt-70 md-pb-70">
          	<div class="container text-center">
          		<h5>Click On The Images To View</h5>
          		<div class="row">
                		
                		<div class="col-md-4">
                			<a href="assets/images/about-01.jpg" target="_blank"><img src="assets/images/about-1.jpg"></a>
                		</div>
                		<div class="col-md-4">
                			<a href="assets/images/about-02.jpg" target="_blank"><img src="assets/images/about-2.jpg"></a>
                		</div>
                		<div class="col-md-4">
                			<a href="assets/images/about-03.jpg" target="_blank"><img src="assets/images/about-3.jpg"></a>
                		</div>
                	</div>
                	</div><br><br><br>-->
                ...
                <div class="container">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-7 pl-60 order-last md-pl-15 md-mb-60">
                            <div class="img-part js-tilt  media-icon">
							<img class="video-img" src="<?php echo BASE_URL; ?>assets/uploads/<?php echo $home_photo_about; ?>" alt="About Photo">
<a class="youtube-videos" href="https://youtu.be/3XCFT8g8dOI" target="_blank">
    ...
    margin-top: -25px;
    color: #21a7d0;
">Click on the Play Button</p>
                            </div>
                        </div>
                        <div class="col-lg-5">
                            <div class="sec-title mb-26 wow fadeInUp" data-wow-delay="300ms" data-wow-duration="2000ms">
                                <div class="sub-title primary">	<?php if($home_subtitle_about!=''): ?>
					<h3><?php echo $home_subtitle_about; ?></h3>
					<?php endif; ?></div>
                                <h2 class="title"><h2><?php if($home_title_about!=''): ?>
									<?php echo $home_title_about; ?></h2>
					<?php endif; ?></h2>
					...
					<?php endif; ?>
                            ...
                            <div class="btn-part wow fadeInUp" data-wow-delay="300ms" data-wow-duration="2000ms">
                                <a class="readon2" href="page/about-us">Read More</a>
                            </div>
                        </div>
                    </div>
                </div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-6 col-md-5">
				<div class="item">
					<img src="<?php echo BASE_URL; ?>assets/uploads/<?php echo $home_photo_about; ?>" alt="About Photo">
				</div>
			</div>
		</div>
	</div>
...
<!-- Team Member Start -->
<section id="rs-popular-courses" class="team-member-v1 rs-popular-courses main-home event-bg pt-100 pb-100 md-pt-70 md-pb-70">
	<div class="container">
		<!-- <div class="row">
			<div class="col-md-12">
 ...
 <div class="item wow fadeInUp">
                           <div class="courses-item">
                                <div class="courses-grid">
                                    <div class="img-part">
                                        <a href="#"><img src="<?php echo BASE_URL; ?>assets/uploads/<?php echo $row['photo']; ?>" alt=""></a>
                                    </div>
                                    <div class="content-part">
                                        ...
                                        <div class="course-price">
                                            ...
                                            <span>
											<?php echo $row['designation_name']; ?></span>
                                        </div>
                                        <h3 class="title"><a href="#"><?php echo $row['name']; ?></a></h3>
                                        <p><?php echo $row['detail']; ?></p>
                                        <ul class="meta-part">
                                            <li class="user">
										     <a href="<?php echo BASE_URL.URL_PAGE.$row['slug']; ?>">Read More</a>                           
                                            </li>
...
<?php endif; ?>
			...
			<!-- About Section Start -->
			<div class="rs-about style1 pb-100  pt-100 md-pb-100">
				<div class="container">
					<div class="row align-items-center">
						<div class="col-lg-6 padding-0 md-pl-15 md-pr-15 md-mb-30">
							<div class="img-part">
								<img class="" src="assets/images/building.jpg" alt="About Image">
							</div>
                            <ul class="nav nav-tabs histort-part" id="myTab" role="tablist">
                                <li class="nav-item tab-btns single-history">
                                    <a class="nav-link tab-btn active" id="about-history-tab" data-toggle="tab" href="#about-history" role="tab" aria-controls="about-history" aria-selected="true"><!-- <span class="icon-part"><i class="flaticon-banknote"></i></span> -->Vision</a>
                                </li>
                                <li class="nav-item tab-btns single-history">
                                ...
                                <li class="nav-item tab-btns single-history">
                                    <a class="nav-link tab-btn" id="about-admin-tab" data-toggle="tab" href="#about-admin" role="tab" aria-controls="about-admin" aria-selected="false"><!-- <span class="icon-part"><i class="flaticon-analysis"></i></span> -->Objectives</a>
                                </li>
                                  <li class="nav-item tab-btns single-history last-item">
                                    <a class="nav-link tab-btn" id="about-motto-tab" data-toggle="tab" href="#about-motto" role="tab" aria-controls="about-motto" aria-selected="false"><!-- <span class="icon-part"><i class="flaticon-analysis"></i></span> -->School Motto</a>
                                </li>
                            </ul>
						</div>
							...
							<div class="tab-content tabs-content" id="myTabContent">
                                <div class="tab-pane tab fade show active" id="about-history" role="tabpanel" aria-labelledby="about-history-tab">
                                    <div class="sec-title mb-25">
                                        ...
                                        <div class="desc">We are committed to educating and improving young
people to be leaders with integrity, outstanding skills and
compassion. Together with our students, faculty, alumni,
parents and international partners, we aim to build a
sustainable and equitable world. Our goal is the holistic
development of children in order to make them future ready,
competitive and value-based citizens of the world.</div>
                                    </div>
                                ...
                                <div class="tab-pane fade" id="about-mission" role="tabpanel" aria-labelledby="about-mission-tab">
                                    <div class="sec-title mb-25">
                                        ...
                                        <div class="desc">Our mission is to equip students with high moral values,
unyielding integrity and matchless education to excel in life
and society. It is to impart education that enables students to
adapt and cope with the demands of a fast changing world
and to inculcate the scientific spirit in them.</div>
                                    </div>
                                ...
                                <div class="tab-pane fade" id="about-admin" role="tabpanel" aria-labelledby="about-admin-tab">
                                    <div class="sec-title mb-25">
                                        ...
                                        <div class="desc">Don Bosco School of Excellence is run according to the
principles of the saintly Founder and aims at developing the
character and personality of each pupil, imparting sound
education through wide training.</div>
                                    </div>
                                  
                                </div>
                                 <div class="tab-pane fade" id="about-motto" role="tabpanel" aria-labelledby="about-motto-tab">
                                    <div class="sec-title mb-25">
                                        <h2 class="title">School Motto</h2>
                                        <div class="desc">Our School Motto is вЂњDUCENS CUM AMORE PROVIDOвЂќ,
meaning вЂњLeading with Foresight and CompassionвЂќ.</div>
                                    </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-7 col-md-12 pr-75 md-pr-15 md-mb-50">
							...
							<div class="sub-title yellow-color"><?php echo $home_subtitle_news; ?></div>
                                <h2 class="title black-color"><?php echo $home_title_news; ?> </h2>
						...
						?>
                                <div class="col-md-6">
                                    <div class="image-part">
                                      <img src="<?php echo BASE_URL; ?>assets/uploads/<?php echo $row['photo']; ?>" alt="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="blog-content">
										...
										<h3 class="title"><a href="page/photo-gallery"><?php echo $row['news_title']; ?></a></h3>
								<p  class="txt"><?php echo $row['news_content_short']; ?></p>
                                    </div>
                                </div>
					...
					?>
                        ...
                        <div class="col-lg-5 lg-pl-0">
                            ...
                            <div class="events-short-top mb-30 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="2000ms">
                                ...
                                <div class="content-part">
                                    <h3 class="title"><a href="#">DBXUBERENZ CULTURAL FEST</a></h3>
                                    <!-- <h5>CATEGORY 1 - STD III TO V</h5> -->
                             ...
                             <!-- <div class="events-short-top mb-30 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="2000ms">
                                ...
                                <div class="content-part">
                                   <h3 class="title"><a href="#">DBXUBERENZ CULTURAL FEST</a></h3>
                                    <h5>CATEGORY 2 - STD VI TO VIII</h5>
                            ...
                            <!--<div class="events-short-top mb-30 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="2000ms">
                                ...
                                <div class="content-part">
                                    <h3 class="title"><a href="#">DBXUBERENZ CULTURAL FEST</a></h3>
                                    <h5>CATEGORY 3 - STD IX TO XII</h5>
...
<!-- Service Start -->
<section class="service-v1 rs-team style1 ">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="sec-title wow fadeInUp mb-50 md-mb-30">
                        <div class="sub-title primary"><?php echo $home_subtitle_service; ?></div>
                        <h2 class="title mb-0"><?php echo $home_title_service; ?></h2>
                    </div>
		...
		<div class="row">
			...
			foreach ($result as $row) {
				?>
				<div class="team-item ser-item wow fadeInUp">
					<div class="item">
						...
						<img src="<?php echo BASE_URL; ?>assets/uploads/<?php echo $row['photo']; ?>" alt="">
						  <div class="content-part">
                                ...
                                <span class="designation"><a href="https://dbschoolofexcellence.in/page/facilities">Click Here</a></span>
