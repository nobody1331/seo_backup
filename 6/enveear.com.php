...
<section class="about gray-bg">
	 <img src="assets/uploads/file-5.png" alt=""  class="aboutimg"  style="height: 373px;">
	<div class="container">
		<div class="row">
			<div class="col-sm-3 col-md-3">
				<div class="item abouttimg">
					<img src="<?php echo BASE_URL; ?>assets/uploads/<?php echo $home_photo_about; ?>" alt="About Photo">
				</div>
			</div>
			<div class="col-sm-6 col-md-6 aboutcenter-card">
				<div class="item">
					...
					<?php endif; ?>
					<div class="bntcenterrrmrg"> <a href="https://enveear.com/page/about-us" class="btn uza-btn btn-2 mt-4">Read More</a></div>
				</div>
			</div>
			
			<div class="col-sm-3 col-md-3">
				<div class="item abouttimg">
					<img src="assets/images/about-us2.jpg" alt="About Photo">
				</div>
			</div>
...
<section class="vission" style="position:relative;">
...
<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-6">
			<h3>Mission</h3>
			<p>To continue providing the highest standards of quality products to our customers that will always be a top priority in our business policy.</p>
<br>

<h3>Vision </h3>
<p>Over the years, Enveear has taken consistent steps to evolve into one of the best names in the business. Keeping in line with our core values, we aspire to challenge ourselves and provide the best products to our valued customers. </p>
			</div>
	<div class="figure">		
			<div class="col-md-6">
			<img src="assets/images/vision.jpg" class="image-block-border visionimg">
			</div>
		</div>
</div>
</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-12 col-md-12">
				<div class="choose mb-80">
					<img src="assets/uploads/file-6.jpg" alt="">
				</div>
			</div>
