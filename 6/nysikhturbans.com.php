					...
					<div class="owl-carousel popular-slider">
						...
						while ($rowBanner=mysqli_fetch_assoc($resBanner)) {                 
							...
							<div class="single-product">
								<div class="single-banner"><a href="#"><img src="<?php echo BANNER_IMAGE_SITE_PATH.$rowBanner['image']?>" alt="#"></a>						 
								</div>
							</div>
							<!-- /End Single Banner  -->
						<?php }?>
     ...
     //prx($get_product);
									foreach ($get_product as $list) {?>
										<div class="col-xl-3 col-lg-4 col-md-4 col-12">											
											<div class="mid_deal_block">
												...
												<div class="mid_deal_block_img"><a href="product_details.php?id=<?php echo $list['id']?>"><img src="<?php echo PRODUCT_IMAGE_SITE_PATH.$list['image']?>"></a></div>
						...
						<div class="tab-pane fade" id="women" role="tabpanel">
							<div class="tab-single">
								<div class="row">	
									<?php
									$resCoupon=mysqli_query($con,"select * from coupon_master where status='1' order by id asc");
									while ($rowCoupon=mysqli_fetch_assoc($resCoupon)) {                 
										?>											 
										<div class="col-xl-3 col-lg-4 col-md-4 col-12">										
											<div class="h_coupon_gm">
												<a class="brand_cupon_gm" href="#">
													<img src="images/brandlogo.png" alt="img">
												</a>

												<h2>Amazon Coupons for Electronics & Accessories : Get Upto 90% Off</h2>
												<p class="coupon_valid"> Valid till: January 31, 2022</p>
												<label class="coponcode_gg"><?php echo $rowCoupon['coupon_code'] ?></label>
											</div>
										</div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="owl-carousel popular-slider">
						...
						<div class="single-banner sli">
							<img class="sli_img" src="<?php echo PRODUCT_IMAGE_SITE_PATH.$list['image'] ?>" alt="#">
							<div class="content">
