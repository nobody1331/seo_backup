...
?>
   ...
   <div>
       <br><br>
<img src="logo/banner.png" style="width:100%">
            ...
            <div class="swiper-container no-slider animation slider-h-100">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide slide-center">
                        <img data-aos="zoom-out-up" data-aos-delay="800" src="logo/Alliance-Excellencia.png" class="hero-image" alt="Hero Image" style="width:750px">
                        <div class="slide-content row" data-mask-768="80">
                            <div class="col-12 d-flex inner">
                                <div class="left align-self-center text-center text-md-left">
                                    <h1 data-aos="zoom-out-up" data-aos-delay="400" class="title effect-static-text" style="color:black">Let's Make it Wonderful</h1>
                                    ...
                                    <a href="contact-us.php" data-aos="zoom-out-up" data-aos-delay="1200" class="btn primary-button"><i class="fa fa-hand-o-right"></i>Contact Us</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section id="slider" class="hero p-0 odd">
            <div class="swiper-container full-slider featured animation slider-h-100">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide slide-center">
                        <img data-aos="zoom-out-up" data-aos-delay="800" src="logo/Alliance-Excellencia.png" class="hero-image" alt="" style="width:750px;">
                        <div class="slide-content row" data-mask-768="70">
                            <div class="col-12 d-flex inner">
                                <div class="left align-self-center text-center text-md-left">
                                    <h1 data-aos="zoom-out-up" data-aos-delay="400" class="title effect-static-text">Let's Make it Wonderful</h1>
                                    <p data-aos="zoom-out-up" data-aos-delay="800" class="description">We work with the most innovative solutions on the market to help you get the best results.</p>
                                    <a href="contact-us.php" data-aos="zoom-out-up" data-aos-delay="1200" class="btn primary-button"><i class="fa fa-hand-o-right"></i>Contact Us</a>
                                </div>
                            </div>
                        ...
                        <div class="slide-content row" data-mask-768="70">
                            <div class="col-12 d-flex inner">
                                <div class="left align-self-center text-center text-md-left">
                                    ...
                                    <p data-aos="zoom-out-up" data-aos-delay="800" class="description">Alliance Excellencia has been an established and popular company with an excellent track record for the best client satisfaction</p>
                                    <a href="contact-us.php" data-aos="zoom-out-up" data-aos-delay="1200" class="btn primary-button"><i class="fa fa-hand-o-right"></i>Contact Us</a>
                                </div>
                            </div>
                        </div>
...
-->
            ...
            <div class="container">
                <div class="row intro">
                    <div class="col-12 col-md-9 align-self-center text-center text-md-left">
                        <h2 class="featured" style="font-family: 'aller';color:black">What We Do</h2>
                        <p style="font-family: 'aller';font-size:20px;color:black">Focused on results we seek to raise the level of our customers.</p>
                    </div>
                    
                </div>
                <div class="row justify-content-center text-center items">
                    <div class="col-12 col-md-6 col-lg-4 item">
                        <a href="design.php"><div class="card"  id="service1">
                            <!--<i class="fa fa-paint-brush" style="font-size:40px;color:#eeaa34"></i>-->
                            <h4 style="font-family: 'aller';font-size:25px;color:#eeaa34"> Design</h4>
                            <p></p>
                            <a href="design.php" style="color:#eeaa34"> See More</a>
                            <br>
                            </div></a>
                    </div>
                    <!--<div class="col-12 col-md-6 col-lg-4 item">
                        <div class="card" id="service1">
                            <i class="fa fa-pencil" style="font-size:40px;color:#eeaa34"></i>
                            <h4 style="font-family: 'aller';font-size:25px;color:#eeaa34">Logo Design</h4>
                           <p></p>
                           <a href="https://api.whatsapp.com/send?phone=919619024433" style="color:#eeaa34" target="_blank"><i class="fa fa-whatsapp"></i> Hit Me</a>
                        </div>
                    </div>-->
                    <div class="col-12 col-md-6 col-lg-4 item">
                         <a href="films-music-videos.php"><div class="card" id="service1">
                            <!--<i class="fa fa-television" style="font-size:40px;color:#eeaa34"></i>-->
                            <h4 style="font-family: 'aller';font-size:25px;color:#eeaa34">Ads/Films/Music</h4>
                            <p></p>
                            <a href="films-music-videos.php" style="color:#eeaa34"> See More</a>
                             <br>
                             </div></a>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4 item">
                        <a href="events.php"><div class="card" id="service1">
                            <!--<i class="fa fa-id-card" style="font-size:40px;color:#eeaa34"></i>-->
                            <h4 style="font-family: 'aller';font-size:25px;color:#eeaa34">Events</h4>
                           <p></p>
                            <a href="events.php" style="color:#eeaa34"> See More</a>
                            <br>
                            </div></a>
                    </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-4 item">
                        <a href="photography.php"><div class="card" id="service1">
                            <!--<i class="fa fa-camera" style="font-size:40px;color:#eeaa34"></i>-->
                            <h4 style="font-family: 'aller';font-size:25px;color:#eeaa34">Photography</h4>
                            <p></p>
                            <a href="photography.php" style="color:#eeaa34"> See More</a>
                            <br>
                            </div></a>
                    </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-4 item">
                        <a href="social.php"> <div class="card" id="service1">
                            <!--<i class="fa fa-mobile" style="font-size:40px;color:#eeaa34"></i>-->
                            <h4 style="font-family: 'aller';font-size:25px;color:#eeaa34">Social</h4>
                            <p></p>
                            <a href="photography.php" style="color:#eeaa34"> See More</a>
                           <br>
                        </div></a>
                    ...
                    <div class="col-12 col-md-6 col-lg-4 item">
                        <a href="https://api.whatsapp.com/send?phone=919619024433" target="_blank"><div class="card" id="service1">
                            <!--<i class="fa fa-globe" style="font-size:40px;color:#eeaa34"></i>-->
                            <h4 style="font-family: 'aller';font-size:25px;color:#eeaa34">Web Development</h4>
                            <p></p>
                           <a href="https://api.whatsapp.com/send?phone=919619024433" style="color:#eeaa34" target="_blank"><i class="fa fa-whatsapp"></i> Hit Me</a>
                            <br>
                            </div></a>
        ...
        <section id="about" class="section-2 highlights image-right" style="background:#f5f5f5">
            <div class="container">
                <div class="row">
                    <div class="col-12 col-md-6 align-self-center text-center text-md-left">
                        <div class="row intro">
                            <div class="col-12 p-0">
                                <h2 class="featured alt" style="font-family: 'aller'">Welcome to Marveilleux.</h2>
                                <p style="font-family: 'aller';font-size:20px;color:black"><b>Arif Ahmed </b> (Founder & Chairperson)</p>
                                <p align="justify" style="font-family: 'aller';font-size:20px;color:black">Arif Ahmed, the dynamic name behind the company is a master of  versatile talents as graphic designer, Screen Writer, Film maker, Artist, Poet and entrepreneur.  </p>
                                
                                <p align="justify" style="font-family: 'aller';font-size:20px;color:black">Arif Ahmed has been working in the field of visual media and print media for past twenty years. Being the name behind many successful brands , he has gained substantial knowledge in the brand making process over the years. Having more than two decades of experience in Mumbai,  he has a unique outlook to brand development and Creative publicity mechanisms. </p>
                                
                                <p align="justify" style="font-family: 'aller';font-size:20px;color:black">With his keen vision, expertise in craft, exceptionally creative ideas adorned by unique strategic concepts, he has been successful in making his mark in the field of brand establishment - be it print, video or events. Bringing all his mastery together under one flag which is Marveilleux.  </p>
                                
                                
                                <p align="justify" style="font-family: 'aller';font-size:20px;color:black">Founded by Arif Ahmed, it consist of Designs, Film Productions, social organization, Events, Media & others. Marveilleux has been established as a company with an excellent track record for the best client satisfaction. It has never compromised on the quality and the services provided to the client. It has excellent team of experts from different fields who put their experiences in successfully making wonderful projects.   </p>
                    ...
                    <div class="gallery col-12 col-md-6">
                        <a href="assets/images/about-1.jpg">
                            <img src="assets/about/arif-new.jpg" class="fit-image" alt="">
                        </a>
                    </div>
                </div>
            </div>
          ...
          <section id="portfolio" class="section-4 offers secondary">
            <div class="container">
                <div class="row intro">
                    <div class="col-12 col-md-9 align-self-center text-center text-md-left">
                        <h2 class="featured" style="font-family: 'aller';color:black">Our Brands</h2>
                        <p style="font-family: 'aller';font-size:24px;color:black"></p>
                    </div>
                ...
                <div class="row justify-content-center text-center items">
                    <div class="col-12 col-md-6 col-lg-4 item">
                        <div class="card featured">
                            ...
                            <div class="gallery">
                                <a href="assets/brand/01.png">
                                    <img src="assets/brand/01.png" alt="" style="width:290px">
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4 item">
                        <div class="card">
                            ...
                            <div class="gallery">
                                <a href="assets/brand/02.png">
                                    <img src="assets/brand/02.png" alt="" style="width:190px">
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4 item">
                        <div class="card featured">
                            ...
                            <div class="gallery">
                                <a href="assets/brand/08.png">
                                    <img src="assets/brand/08.png" alt="" style="width:210px">
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row justify-content-center text-center items">
                    <div class="col-12 col-md-6 col-lg-4 item">
                        <div class="card featured">
                            ...
                            <div class="gallery">
                                <a href="assets/brand/04.png">
                                    <img src="assets/brand/04.png" alt="" style="width:200px">
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4 item">
                        <div class="card">
                            ...
                            <div class="gallery">
                                <a href="assets/brand/05.png">
                                    <img src="assets/brand/05.png" alt="" style="width:125px">
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4 item">
                        <div class="card featured">
                            ...
                            <div class="gallery">
                                <a href="assets/brand/06.png">
                                    <img src="assets/brand/06.png" alt="" style="width:75px">
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row justify-content-center text-center items">
                    <div class="col-12 col-md-6 col-lg-4 item">
                        <div class="card featured">
                            ...
                            <div class="gallery">
                                <a href="assets/brand/07.png">
                                    <img src="assets/brand/07.png" alt="" style="width:160px">
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4 item">
                        <div class="card">
                            ...
                            <div class="gallery">
                                <a href="assets/brand/03.png">
                                    <img src="assets/brand/aawaz.png" alt="" style="width:170px">
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row text-center intro">
                        <div class="col-12"><br>
                            <h2 style="font-family: 'aller';color:black">Associates & Advisor</h2>
                            ...
                            <div class="swiper-slide slide-center text-center item">
                                <div class="row card">
                                    <div class="col-12">
                                        <img src="assets/advisor/dharmendra.jpg" alt="" class="person" style="max-width:300px">
                                        <h4 style="font-family: 'aller';font-size:25px;color:black">Dr. Dharmendra Kumar <br>
                                        
                                        <span style="font-size:16px;font-family: 'aller';color:black">(Chairman , RK HIV Aids Research & Care Centre)</span>

                                        </h4>
                                        
                                        <p style="font-family: 'aller';font-size:20px;color:black">Unique, committed and versatility thats what makes Arif Ahmed a creative brand. <br>A combination of Professionalism and honesty is always seen in his work pattern and execution. <br>A great mind with a great heart. <br><br>I wish him all the very best</p>
                        ...
                        <div class="swiper-pagination"></div>
                            ...
                            <div class="swiper-slide slide-center text-center item">
                                <div class="row card">
                                    <div class="col-12">
                                        <img src="assets/advisor/barun.jpg" alt="" class="person" style="max-width:300px">
                                        <h4 style="font-family: 'aller';color:black">Baruneshwar Tripathi<br>
                                        
                                            <span style="font-size:16px;font-family: 'aller';color:black">(Business Head Makshi Health care Pvt ltd)</span>
                                        
                                        </h4>
                                        <p style="font-family: 'aller';font-size:20px;color:black">Design is a bridge between the clients and the audience and Mr Arif knows it extremely well .He  has a fine sense of colours  <br>and deliver the best to his clients . He is very much sincere and dedicated towards his creativity <br>and gives his full energy towards the satisfaction of his clients . <br><br>I wish him all the best.</p>
...
<div class="swiper-slide slide-center text-center item">
                                <div class="row card">
                                    <div class="col-12">
                                        <img src="assets/advisor/ak.jpg" alt="" class="person" style="max-width:300px">
                                        <h4 style="font-family: 'aller';color:black">AYUB KHAN<br>
                                        
                                            <span style="font-size:16px;font-family: 'aller';color:black">Advisor</span>
                                        
                                        </h4>
                                        <p style="font-family: 'aller';font-size:20px;color:black">A well known Producer, director and Distributor, Ayub Khan posses a weighty profile to his credit<br> Being in hindi film industry for more than 30 years he has produced, directed and distributed many films.<br> He owns film production house, distribution platform, event management, news media and other enterprises.<br> Apart from films and media business he would be soon organizing an international mega award show and has promising plans for other cities also.</p>
