                        ...
                        <div class="row">
                            <div class="col col-md-6 slide-caption">
                                <div class="slide-title">
                                    <h2>RK HIV Aids Research <span>& Care Centre</span></h2>
                                </div>
                                ...
                                <div class="btns">
                                    <a href="donate-now.php" class="theme-btn">Donate Now</a>
                                    <a href="about-rkhiv.php" class="theme-btn-s2">Know More</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<center><img src="certificate.jpg" style="width:100%"></center>
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-6 col-12 custom-grid">
                            <div class="wpo-mission-item">
                                    ...
                                    <img src="assets/icon/medical.png" width="150px">
                        ...
                        <div class="col-md-3 col-sm-6 col-12 custom-grid">
                            <div class="wpo-mission-item">
                                    ...
                                    <img src="assets/icon/events.png" width="149px">
                        ...
                        <div class="col-md-3 col-sm-6 col-12 custom-grid">
                            <div class="wpo-mission-item">
                                    ...
                                    <img src="assets/icon/social.jpg" width="184px">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 colsm-12">
                        <div class="wpo-about-text">
                            ...
                            <p style="color:black" align="justify">We are specialised in the treatment ,management and research of Antiretroviral cases. We organize medical camps in slums and rural area where health services are not available to destitute and needy people. 
</p>
                            <p style="color:black" align="justify">We have adopted 1300 villages across India and thru our MMVs (Mobile Medical Vans)we are distributing lakhs of hand sanitizers, Masks, soaps , medicines to slums and villages across West Bengal, Odisha, Gujarat, Jharkhand and Maharashtra.</p>
                            <div class="btns">
                                <a href="about-rkhiv.php" class="theme-btn">Learn More</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 colsm-12">
                ...
                <div class="row">
                    <div class="col-lg-7 col-md-6 colsm-12">
                        <div class="wpo-about-img-2">
                            <img src="assets/images/data/dharmemendra.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-lg-5 col-md-6 colsm-12">
                        <div class="wpo-about-text-2">
                            <div class="wpo-section-title">
                                ...
                                <h2>Dr Dharmendra Kumar</h2>
                            </div><p>Born & brought up in Andarshivan – Bihar in the 1973, in the family of Farmers, under the political influence. He seemed to be quiet socially inclined since school days pertaining the village circumstances. His major part of life was spent in Patna & Mumbai, where he stayed for his education & completion of Medical studies


</p>
                            <p>The first thought of having a NGO, popped his mind while working for Reliance Refinery as a Chief Medical Advisor, wherein he used to attend a lot of Medical camps, in rural parts of the country, conducted under the company’s banner. </p>
                            <div class="btns">
                                <a href="our-chairman.php" class="theme-btn">Know More</a>
                            </div>
                        </div>
                    </div>
                </div>
...
//include "counter.php";
//?>    <div class="wpo-world-area-2">
              <div class="container">
                   <div class="row">
                    <div class="col-12">
                         <div class="wpo-world-section">
                            <h2>Lets Change The World With Humanity</h2> 
                            <a href="donate-now.php"><img src="assets/images/team/1.png" alt="">Donate Now</a>
                        </div>
                    </div>
                </div>
              </div>
