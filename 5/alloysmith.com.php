		...
		<div class="section-title">
			<div class="row">
				...
				<div class="col-md-8 col-sm-7 col-xs-12 font-20">
					<p>We have built an enviable reputation in Engineering, Procurement of PSA Nitrogen and <br>Oxygen Plants, Heavy Industries, High-Tech Manufacturing, Testing and expediting. </p>
				</div>
			</div>
		</div>		
		<div class="row">
			...
			<div class="col-md-4 col-sm-6">
				<div class="single-our-service">
					<figure class="img-box">
						<a href="#"><img src="images/service/ma.jpeg" alt="Awesome Image" style="height:180px;width:368px;"/></a>
					</figure>
					<a href="#"><h4>Mechanical Engineering</h4></a>
					<p>We are the best for mechanical engineering and piping solutions.  </p>
				</div>
			</div>
			<div class="col-md-4 col-sm-6">
				<div class="single-our-service">
					<figure class="img-box">
						<a href="#"><img src="images/service/5.jpg" alt="Awesome Image" style="height:180px;width:368px;"/></a>
					</figure>
					<a href="#"><h4>Petroleum and Gas</h4></a>
			...
			<div class="col-md-4 col-sm-6">
				<div class="single-our-service">
					<figure class="img-box">
						<a href="#"><img src="images/service/6.jpg" alt="Awesome Image" style="height:180px;width:368px;"/></a>
					</figure>
					<a href="#"><h4>Power and Energy</h4></a>
					<p>Ensuring high reliability and optimal performance of <br>
			...
			<div class="col-md-4 col-sm-6">
				<div class="single-our-service">
					<figure class="img-box">
						<a href="#"><img src="images/service/ps.jpeg" alt="Awesome Image" style="height:180px;width:368px;"/></a>
					</figure>
					<a href="#"><h4>PSA Nitrogen and Oxygen Plant</h4></a>
					<p></p>
				</div>
			</div>
			<div class="col-md-4 col-sm-6">
				<div class="single-our-service">
					<figure class="img-box">
						<a href="#"><img src="images/service/ps2.jpeg" alt="Awesome Image" style="height:180px;width:368px;"/></a>
					</figure>
					<a href="#"><h4>Defence</h4></a>
					<p></p>
				</div>
			</div>
			<div class="col-md-4 col-sm-6">
				<div class="single-our-service">
					<figure class="img-box">
						<a href="#"><img src="images/service/ps3.jpeg" alt="Awesome Image" style="height:180px;width:368px;"></a>
					</figure>
					<a href="#"><h4>Nuclear and Aerospace</h4></a>
					<p></p>
				</div>
			</div>
...
<section class="call-to-action-home" style="background: url(images/background/call-out.jpg);">
	<div class="container">
		<p>No matter what type of engineering project you have, We can help. <br> <a href="contact.php">Submit </a> your project today!</p>
	</div>
</section>
		...
		<div class="section-title text-center">
			<div class="row">
				<div class="col-md-12">
					...
					<br>
					<p><span class="bold thm-color" style="font-size:18px;">AlloySmith Engineering Company, India's one of the fastest growing Technical Consultant and Manufacture of Engineering Plants & Piping Products.</span></p>
...
We provides Project engineering services which includes Manufacturing of engineering and piping goods, Mechanical, Civil & Structural, Electrical and Instrumentation for EPC companies end users. AlloySmith provides cost effective qualitative services to many National & International Clients to help them to reduce their design lead time. We at AlloySmith, take pride to offer end-to-end Cost effective and Quality Engineering services to include, but not limited to following:<br>

•	Plant & Equipment layout and design<br>

•	Manufacturing of Forgings as per ASME, API, AWWA, DIN, BS and Aerospace/Defense Specifications. <br>
•   Complete engineering related to Process, Mechanical, Utilities, Water/Waste/Effluent Treatment of Process plants.<br>
•   Preparation of MR, PR, TBA, Vendor document review (VDR) Mechanical Data Sheet (MDS), Design calculation, Stress Analysis, 
Mechanical designing of Piping items like Flanges, Forgings, Static Equipment to include Pressure Vessel, Heat Exchangers, Tube bundle, 
Column, Reactors, Evaporators, Boiler & Re-boiler under IBR, Storage Bullets under PESO, Equipment under U, U2 & R Designator, Chimney,
 Scrubber & Ventury, Hydrogen Gas Holder, Brine Clarifire, Distillation, Extraction & Oxidiser column, FRP Equipments and Ladder, Platform & 
 its its extrenal cleats as per ASME, BSEN, PD5500, PESO, ST-1, IBR, GEP, RP & TEMA requirements.<br>
•   Pipe Stress Analysis.<br>
•   Piping Layout and 3-D Modeling.<br>
•   Design & drawing of Steel Structure as per AISC using StaadPro and TEKLA Model.<br>
•   Preparation of concrete and Steel Structure detail drawings.<br>
•   AlloySmith Engineers are experienced Engineers consistently work with diligence & meticulous efforts to augment and assist our global Clientele with Design and Engineering as per industry practice codes & standards in following sectors :<br>
•   Nuclear, Aerospace, Defense, Power Generation, Oil & Gas, Bio-Gag, Cement, Steel & mineral, Chemical and Petrochemical.<br>
</span>
					</p>
				</div>
				<div class="call-out clearfix">
					<div class="pull-left"><a href="about.php" class="thm-btn thm-color thm-tran-bg">Read More</a></div>
		...
		<div class="row">
			 ...
			 <div class="col-md-3 col-sm-4 col-xs-6">
				<div class="single-team-member">
					<figure class="img-box">
						<a href="#"><img src="images/service/product/cylinder.jpg" alt="" style="margin-top: 83px;
    width: 260px;
    height: 238px;"></a>
					</figure>
					<center><h4><b>CYLINDERS</b></h4></center>
					<a href="#"><p class="position"></p></a>
             ...
             <div class="col-md-3 col-sm-4 col-xs-6">
				<div class="single-team-member">
					<figure class="img-box">
						<a href="#"><img src="images/service/product/2.jpg" alt="" style="width:275px;"></a>
					</figure>
						<center><h4><b>BALL VALVES </b></h4></center>
					    <a href="#"><p class="position"></p></a>
				</div>
			</div>
		    ...
		    <div class="col-md-3 col-sm-4 col-xs-6">
				<div class="single-team-member">
					<figure class="img-box">
						<a href="#"><img src="images/service/product/fans.jpg" alt="" style="margin-top: 91px;
    width: 275px;
    height: 225px;"></a>
					</figure>
					<center><h4><b>FANS</b></h4></center>
					<a href="#"><p class="position"></p></a>		
				</div>
			</div>
			 ...
			 <div class="col-md-3 col-sm-4 col-xs-6">
				<div class="single-team-member">
					<figure class="img-box">
						<a href="#"><img src="images/service/product/4.jpg" alt="" style="width:275px;"></a>
					</figure>
					<center><h4><b>SPECIAL FLANGES / FORGINGS</b></h4></center>
					<a href="#"><p class="position"></p></a>	
				</div>
			</div>
			...
			<div class="row">
			 ...
			 <div class="col-md-3 col-sm-4 col-xs-6">
				<div class="single-team-member">
					<figure class="img-box">
						<a href="#"><img src="images/service/product/5.jpg" alt="" style="width:275px;"></a>
					</figure>
					<center><h4><b>SPECIAL FITTINGS</b></h4></center>
					<a href="#"><p class="position"></p></a>	
				</div>
			</div><div class="col-md-3 col-sm-4 col-xs-6">
				<div class="single-team-member">
					<figure class="img-box">
						<a href="#"><img src="images/service/product/6.jpg" alt="" style="width:275px;"></a>
					</figure>
					<center><h4><b>FORGED FITTINGS</b></h4></center>
					<a href="#"><p class="position"></p></a>	
				</div>
			</div>
		    ...
		    <div class="col-md-3 col-sm-4 col-xs-6">
				<div class="single-team-member">
					<figure class="img-box">
						<a href="#"><img src="images/service/product/7.jpg" alt="" style="width:275px;"></a>
					</figure>
					<center><h4><b>WELDED PIPES</b></h4></center>
					<a href="#"><p class="position"></p></a>	
				</div>
			</div>
			 ...
			 <div class="col-md-3 col-sm-4 col-xs-6">
				<div class="single-team-member">
					<figure class="img-box">
						<a href="#"><img src="images/service/product/8.jpg" alt="" style="width:275px;"></a>
					</figure>
					<center><h4><b>STUDBOLTS</b></h4></center>
					<a href="#"><p class="position"></p></a>	
				</div>
			</div>
			...
			<div class="row">
			 ...
			 <div class="col-md-3 col-sm-4 col-xs-6">
				<div class="single-team-member">
					<figure class="img-box">
						<a href="#"><img src="images/service/product/9.jpg" alt="" style="width:275px;"></a>
					</figure>
					<center><h4><b>BUTT WELD FITTINGS</b></h4></center>
					<a href="#"><p class="position"></p></a>	
				</div>
			</div>
             ...
             <div class="col-md-3 col-sm-4 col-xs-6">
				<div class="single-team-member">
					<figure class="img-box">
						<a href="#"><img src="images/service/product/10.jpg" alt="" style="width:275px;"></a>
					</figure>
					<center><h4><b>FORGED STEEL GATE GLOBE AND CHECK VALVES</b></h4></center>
					<a href="#"><p class="position"></p></a>	
				</div>
			</div>
		    ...
		    <div class="col-md-3 col-sm-4 col-xs-6">
				<div class="single-team-member">
					<figure class="img-box">
						<a href="#"><img src="images/service/product/11.jpg" alt="" style="width:275px;"></a>
					</figure>
					<center><h4><b>SEAMLESS PIPLS</b></h4></center>
					<a href="#"><p class="position"></p></a>	
				</div>
			</div>
			 ...
			 <div class="col-md-3 col-sm-4 col-xs-6">
				<div class="single-team-member">
					<figure class="img-box">
						<a href="#"><img src="images/service/product/12.jpg" alt="" style="width:275px;"></a>
					</figure>
					<center><h4><b>FlANGES</b></h4></center>
					<a href="#"><p class="position"></p></a>	
				</div>
			</div>
...
<section class="clients-section">
	...
	<div class="container">
			...
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<h2>Our Associate's Approvals</h2>
					<span class="decor"></span>
				</div>
		...
		<div class="client-carousel owl-carousel owl-theme">
			...
			<div class="item">
				<img src="images/clients/clilets/s (1).jpeg" alt="Awesome Image"  style="width:300px;height:300px;"/>
			</div>
			
			<div class="item">
				<img src="images/clients/clilets/s (2).jpeg" alt="Awesome Image" style="width:300px;height:300px;"/>
			</div>
			
			<div class="item">
				<img src="images/clients/clilets/s (3).jpeg" alt="Awesome Image" style="width:300px;height:300px;"/>
			</div>
			
			<div class="item">
				<img src="images/clients/clilets/s (4).jpeg" alt="Awesome Image" stylDefencee="width:300px;height:300px;"/>
			</div>

			<div class="item">
				<img src="images/clients/clilets/s (5).jpeg" alt="Awesome Image" style="width:300px;height:300px;"/>
			</div>
            
            <div class="item">
				<img src="images/clients/clilets/s (6).jpeg" alt="Awesome Image" style="width:300px;height:300px;"/>
			</div>
			
			<div class="item">
				<img src="images/clients/clilets/s (7).jpeg" alt="Awesome Image" style="width:300px;height:300px;"/>
			</div>
			
			<div class="item">
				<img src="images/clients/clilets/s (8).jpeg" alt="Awesome Image" style="width:300px;height:300px;"/>
			</div>
			
			<div class="item">
				<img src="images/clients/clilets/9.jpeg" alt="Awesome Image" style="width:300px;height:300px;"/>
			</div>
			
			<div class="item">
				<img src="images/clients/clilets/10.jpeg" alt="Awesome Image" style="width:300px;height:300px;"/>
			</div>
