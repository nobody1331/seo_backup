...
?>
            <section class="flexslider-container height-auto">            
                <div class="flexslider slider">
                    <ul class="slides">
                        <li class="item-1" style="background:linear-gradient(rgba(0, 0, 0,.2),rgba(0, 0, 0,.2)),url(slider/2.jpg) 50% 25%;
    	background-size:cover;
    	height:100%;">
                        	<div class="meta meta-padding-200 meta-style-1 txt-white">         
                                <div class="container">
                                    <p>Welcome to</p>
                                    <h1>Secret Goa Villas</h1>
                                    <p>Specialize in luxury private pool villas with a high focus on privacy.</p>
                                    <div class="category">
                                        <a href="about-us.php"><button class="btn btn-lg my-btn btn-yellow">Learn More <i class="fa fa-angle-right"></i></button></a>
                                        <a href="villas.php"><button class="btn btn-lg my-btn btn-white bg-grey">Villas <i class="fa fa-angle-right"></i></button></a>
                                    </div>
                                </div>  
                            </div>
                        </li>
                        <li class="item-2" style="background:linear-gradient(rgba(0, 0, 0,.2),rgba(0, 0, 0,.2)),url(slider/1.jpg) 50% 25%;
    	background-size:cover;
    	height:100%;">
                            <div class="meta meta-padding-200 meta-style-1 txt-white">         
                                <div class="container">
...
<div id="myBtnContainer">
  ...
  <button class="btn" onclick="filterSelection('2BED')"> 2 BED VILLAS</button>
  <button class="btn" onclick="filterSelection('3BED')"> 3 BED VILLAS</button>
  <button class="btn" onclick="filterSelection('4BED')"> 4 BED VILLAS</button>
    <button class="btn" onclick="filterSelection('5BED')"> 5 BED VILLAS</button>
    <button class="btn" onclick="filterSelection('6BED')"> 6 BED VILLAS</button>
    <button class="btn" onclick="filterSelection('7BED')"> 7 BED VILLAS</button>
</div>
<div class="row">
         <?php
include("config.php");
...
$query = "SELECT * FROM villa where category='2bed' order by id DESC LIMIT $start_from, $record_per_page";
...
?> 
  ...
  <div class="column 2BED">
    <div class="content">
        
    <a href="details.php?id=<?php echo $row["id"]; ?>"><img src="2bed/<?php echo $row["image"]; ?>" alt="Lights" style="width:100%"></a><br><br>
        <center><a href="details.php?id=<?php echo $row["id"]; ?>" style="color:black"><h4><?php echo $row["villa_name"]; ?></h4></a></center>
      <!--<center><p></p></center>-->
        <center><p><i class="fa fa-user"> <?php echo $row["guests"]; ?></i>&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-bed"> <?php echo $row["bed_size"]; ?></i></p></center>
    </div>
...
$query = "SELECT * FROM villa where category='3bed' order by id DESC LIMIT $start_from, $record_per_page";
                $result = mysqli_query($conn, $query);
...
?> 
  ...
  <div class="column 3BED">
    <div class="content">
        
    <a href="details.php?id=<?php echo $row["id"]; ?>"><img src="2bed/<?php echo $row["image"]; ?>" alt="" style="width:100%"></a><br><br>
        <center><a href="details.php?id=<?php echo $row["id"]; ?>" style="color:black"><h4><?php echo $row["villa_name"]; ?></h4></a></center>
       <!--<center><p></p></center>-->
        <center><p><i class="fa fa-user"> <?php echo $row["guests"]; ?></i>&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-bed"> <?php echo $row["bed_size"]; ?></i></p></center>
    </div>
...
$query = "SELECT * FROM villa where category='4bed' order by id DESC LIMIT $start_from, $record_per_page";
                $result = mysqli_query($conn, $query);
...
$query = "SELECT * FROM villa where category='5bed' order by id DESC LIMIT $start_from, $record_per_page";
                $result = mysqli_query($conn, $query);
...
$query = "SELECT * FROM villa where category='6bed' order by id DESC LIMIT $start_from, $record_per_page";
                $result = mysqli_query($conn, $query);
...
$query = "SELECT * FROM villa where category='7bed' order by id DESC LIMIT $start_from, $record_per_page";
                $result = mysqli_query($conn, $query);
  ...
  <div class="column 7BED">
    ...
    <section id="services" class="section-padding">
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-12 col-lg-12 col-xl-12">
                    <div class="page-heading">
                        <h2>Our <span>Awesome Facilities</span></h2>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6 col-lg-3 col-xl-3">
                                <div class="service-block">
                                    ...
                                    <h2 class="service-name">Strong Wifi</h2>
                                </div>
                            </div>
                            <div class="col-12 col-md-6 col-lg-3 col-xl-3">
                                <div class="service-block">
                                    <span><i class="fa fa-check-circle"></i></span>
                                    <h2 class="service-name">Free Parking</h2>
                                </div>
                            </div>
                            <div class="col-12 col-md-6 col-lg-3 col-xl-3">
                                <div class="service-block">
                    ...
                    <div class="butn text-center">
                        <a href="about-us.php" class="btn btn-lg btn-padding btn-g-border">See More</a>
                    </div>
            ...
            <!--<section id="who-we-are" class="section-padding">
                <div class="container">
                    <div class="row">
                        
                        <div class="col-12 col-md-12 col-lg-12 col-xl-12 who-we-text">
                            <div class="page-heading-2">
                                <h2>Why <span>Choose Us</span></h2>
                            </div>
                            <p style="color:black" align="justify">We are a bunch of Goa fanatics based out of Mumbai and Goa, over the years we got tiered staying at hotels, resorts and hostels, and as we grew up in life we wanted some privacy even in the hustle-bustle and sort-of our own space with the same service of a hotel.
This led to the birth of Secret Goa Villas, we specialize in luxury private pool villas with a high focus on privacy.
At the request of some villa owners, a few of our properties cannot be listed here. Please contact us if you do not find what you are looking for and we will be delighted to contact you with suggestions.</p>
                            <ul class="list-unstyled about-lines">
                                <li><span><i class="fa fa-chevron-right"></i></span><p style="color:black" >Strong Wifi</p></li>
                                <li><span><i class="fa fa-chevron-right"></i></span><p style="color:black" >Free parking on premises</p></li>
                                <li><span><i class="fa fa-chevron-right"></i></span><p style="color:black" >Pool</p></li>
                                <li><span><i class="fa fa-chevron-right"></i></span><p style="color:black" >Garden or backyard</p></li>
                                <li><span><i class="fa fa-chevron-right"></i></span><p style="color:black" >Private Entrance</p></li>
                            </ul>
                            <center> <a href="about-us.php" class="btn btn-success" style="background:#474747">See More</a></center>
                        </div>
