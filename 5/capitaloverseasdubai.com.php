    ...
    <div class="tp-banner">
        <ul>
            ...
            <!-- SLIDE 03-->
                         ...
                         <?php  $sq5 = "SELECT * FROM `social_link`";
...
?>
            ...
            <li data-transition="zoomout" data-slotamount="7"  data-masterspeed="1500">
                <!-- MAIN IMAGE -->
                <img src="images/<?php echo $list['image']; ?>"  alt="slidebg1"  data-bgposition="left center" data-kenburns="on" data-duration="10000" data-ease="Linear.easeNone" data-bgfit="130" data-bgfitend="100" data-bgpositionend="right center">
                ...
                <div class="tp-caption medium_text lfb tp-resizeme"
                    ...
                    data-endelementdelay="0.1"
                    data-endspeed="300">
                    Customer satisfaction is our victory.
                </div>
                <!-- END LAYER NR. 3 -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 padding-top-mini">
                    <!-- Title - Subtitle  --><?php  $sq5 = "SELECT * FROM `page` where id  = 5";
...
foreach($lanews as $list){ 
?>
                    <h2 class="title-subtitle" style="font-size:24px;">
                        <?php echo $list['title']; ?></b>
                    </h2>
                    <!-- End Title - Subtitle  -->
                    <p class="delay2"><?php echo $list['desc']; }?> </p>
                    <a class="btn btn-lg btn-primary delay4" href="aboutus.php">Read More</a>
...
<section class="content_info">
    ...
    <section class="opacy_bg_02 paddings sponsors">
        <div class="container wow fadeInUp">
            <h2 class="title-resalt">COMPANIES WE’VE WORKED WITH</h2>
            <!-- Sponsors -->
            <ul id="sponsors">
                <!-- Sponsor -->
                ...
                <li data-toggle="tooltip" title data-original-title="Tooltip Hover">
                  ...
                  <li data-toggle="tooltip" title data-original-title="Tooltip Hover">
                    <a href="#"><img src="images/c444.jpg" alt=""></a>
                </li>
           
                
                  <li data-toggle="tooltip" title data-original-title="Tooltip Hover">
                    <a href="#"><img src="images/c44.jpg" alt=""></a>
                </li>
                  ...
                  <li data-toggle="tooltip" title data-original-title="Tooltip Hover">
                    <a href="#"><img src="images/c434.jpg" alt=""></a>
                </li>
                  ...
                  <li data-toggle="tooltip" title data-original-title="Tooltip Hover">
                    <a href="#"><img src="images/c433.jpg" alt=""></a>
                </li>
