...
<head>
	    ...
	    <title>Blooms N Buds Florist</title>
						...
						<div class="row">
							<div class="col-md-3 col-sm-3 col-lg-3">
								<div class="info-box">
									<div class="row">
										...
										<div class="col-xs-10">
											<h4 class="info-box-heading green">ALWAYS FRESH</h4>
										</div>
									</div>
									<h6 class="text text-center">PRODUCT WELL PACKAGE</h6>
								</div>
							</div><!-- .col -->
							...
							<div class="hidden-md col-sm-3 col-lg-3">
								<div class="info-box">
									...
									<h6 class="text text-center">ON ORDER OVER RM100</h6>
								</div>
							</div><!-- .col -->
							...
							<div class="col-md-3 col-sm-3 col-lg-3">
								<div class="info-box">
									<div class="row">
										...
										<div class="col-xs-10">
											<h4 class="info-box-heading green">SUPERIOR QUALITY</h4>
										</div>
									</div>
									<h6 class="text text-center">QUALITY PRODUCTS </h6>
								</div>
							</div><!-- .col -->
							<div class="col-md-3 col-sm-3 col-lg-3">
											<div class="info-box">
												<div class="row">
													...
													<div class="col-xs-10">
														<h4 class="info-box-heading green">SUPPORT</h4>
													</div>
												</div>
												<h6 class="text text-center">24/7 SUPPORT </h6>
											</div>
							</div><!-- .col -->
						</div><!-- /.row -->
	...
	<div class="product product-main">
		<div class="product-image">
			<div class="image">
				...
				<img  src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>" alt="" width="250" height="280"></a>
			</div><!-- /.image -->
		</div><!-- /.product-image -->
			...
			<div class="action text-center">
						...
						<div class="add-cart-button btn-group">
								...
								<?php if($row['productAvailability']=='In Stock'){?>
										<button class="btn btn-primary-rose icon" data-toggle="dropdown" type="button">
								<i class="fa fa-shopping-cart"></i>
							</button>
							<a href="category.php?page=product&action=add&id=<?php echo $row['id']; ?>">
							<button class="btn btn-primary-rose no-border-radius" type="button">Add to cart</button></a>
								<?php } else {?>
