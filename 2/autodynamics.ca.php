...
$fetchwheels=$conn->prepare("select * from products where product_category=? and product_status=? order by product_id desc limit 10");
$fetchwheels->execute(array(24,1));
$datawheel=$fetchwheels->fetchAll();


$fetchtires1=$conn->prepare("select * from products where product_category=? and construction=? and product_status=? order by product_id desc limit 10");
$fetchtires1->execute(array(23,'RADIAL',1));
$datatires1=$fetchtires1->fetchAll();

$fetchtires2=$conn->prepare("select * from products where product_category=? and product_status=? order by product_id desc limit 10");
$fetchtires2->execute(array(24,1));
$datatires2=$fetchtires2->fetchAll();


$fetchwheeltype=$conn->prepare("select distinct(wheeltype) from products where wheeltype!=? and product_status=?  ");
$fetchwheeltype->execute(array('',1));
$datawheeltype=$fetchwheeltype->fetchAll();

$fetchslider=$conn->prepare("select * from sliders order by slider_id desc");
$fetchslider->execute();
$dataslider=$fetchslider->fetchAll();
 ?>
 <div class="heightad"></div>
 <div class="slider p-relative">
    <div class="main-banner arrow-layout-1 ">
      <?php foreach($dataslider as $dataSl){ ?>
      <div class="slide-item"> <img src="admin/upload/sliders/<?php echo $dataSl['slider_img'];?>" class="image-fit" alt="Slider">
        <div class="transform-center">
          <div class="container">
            <div class="row">
              <div class="col-lg-10 offset-lg-1">
                <div class="slider-content text-center">
                  <h1 class="text-custom-white s1"><?php echo $dataSl['slider_title'];?></h1>
                  <h1 class="text-custom-white s2"><?php echo $dataSl['slider_subtitle'];?></h1>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-10 p0">
          <input type="text" placeholder="Search Products..." name="s" class="form-control searchinput"> 
        </div>
        <div class="col-md-2 p0">
           <button type="submit" class="btn-first btn-submit full-width btn-height1" >Search</button>
        </div>
              ...
              <div class="tab-pane active" id="cars">
                <div class="tab-inner">
                  <form>
					...
					<h3>Wheel & Tire search by Vehicle</h3> 
					
                     </div>
                      
                      <div class="col-lg-12 col-md-12" style="border:solid 1px #ccc; padding:20px">
                        <div class="row">
                         <br>
                         <br>
                          ...
                          <div class="col-20">
                            <div class="form-group">
                              <label class="fs-16 fw-600">Year:</label>
						    ...
						    <div class="col-20">
                            <div class="form-group">
                              <label class="fs-14 fw-600">Make</label>
                              <div class="group-form">
						    ...
						    <div class="col-20">
                            <div class="form-group">
                              <label class="fs-14  fw-600">Model</label>
                              <div class="group-form">
						    ...
						    <div class="col-20">
                            <div class="form-group">
                              <label class="fs-14  fw-600">Part Type</label>
                              <div class="group-form ">
                                  <select class="form-control selectCategory" id="selectCategory" onchange="parttype(this.value)" >
                            ...
                            <div class="form-group forwheel" style="display: none">
                                <p style="font-weight: bold; margin-bottom: 0px"><input type="radio" name="Stock" value="Stock" checked="checked"> Stock</p>
                                 <p  style="font-weight: bold;margin-bottom: 0px"><input type="radio" name="Stock" value="Lifted"> Lifted Application</p>
                              </div>
                          </div>
                          ...
                          <div class="col-20">
                            <div class="form-group">
                              ...
                              <button type="button" class="btn-first btn-submit full-width btn-height" id="search_customProduct">Search</button>
                            </div>
                          </div>
    ...
    <div class="container">
      <div class="section-header text-center">
        <div class="section-heading">
          <h3 class="text-custom-black"><span class="text-custom-blue">LATEST</span> WHEELS</h3>
      ...
      <div class="row">
        <div class="col-12">
          <div class="blog-slider arrow-layout-2 row">
            <!-- article -->
            <?php foreach($datatires2 as $rowtires2){ ?>
            <article class="col-12 post slide-item">
              <div class="post-wrapper bx-wrapper">
                <div class="post-img animate-img bg-custom-white  padding-20 text-center"> <a href="product-details.php?pid=<?php echo $rowtires2['product_id'];?>"> <img src="admin/<?php echo $rowtires2['simage'];?>" class="tirelisting-img"></a>
                 <div class="post-heading blog-meta  text-center">
                    <h2> <a href="product-details.php?pid=<?php echo $rowtires2['product_id'];?>" class="text-custom-black fw-600 fs-20 text-center"><?php echo $rowtires2['product_title'];?></a> </h2>
                   </div> 
                </div>
 ...
 <section class="section-padding  our_articles">
    <div class="container">
      <div class="section-header text-center">
        <div class="section-heading">
          <h3 class="text-custom-black"><span class="text-custom-blue">LATEST</span> RADIAL TIRES</h3>
      ...
      <div class="row">
        <div class="col-12">
          <div class="blog-slider arrow-layout-2 row">
            <!-- article -->
            <?php foreach($datatires1 as $rowtires1){ ?>
            <article class="col-12 post slide-item">
              <div class="post-wrapper bx-wrapper">
                <div class="post-img animate-img bg-custom-white  padding-20 text-center"> <a href="product-details.php?pid=<?php echo $rowtires1['product_id'];?>"><img src="admin/<?php echo $rowtires1['simage'];?>" class="img-fluid tirelisting-img"> </a>
                 <div class="post-heading blog-meta  text-center">
                    <h2> <a href="product-details.php?pid=<?php echo $rowtires1['product_id'];?>" class="text-custom-black fw-600 fs-20 text-center"><?php echo $rowtires1['product_title'];?></a> </h2>
                   </div> 
                </div>
