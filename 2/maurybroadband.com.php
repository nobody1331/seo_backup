...
<?php 
    ...
    $nquery3=mysqli_query($conn,"select * from `home` where type='home1' ORDER BY home_id ASC limit 1");
    $nquery4=mysqli_query($conn,"select * from `home` where type='home2' ORDER BY home_id ASC limit 1");
    $nquery5=mysqli_query($conn,"select * from `home` where type='home3' ORDER BY home_id ASC limit 1");
    $nquery6=mysqli_query($conn,"select * from `blog` ORDER BY id ASC limit 6");
    $nquery7=mysqli_query($conn,"select * from `calculator` ORDER BY calculator_id ASC limit 4");
?>

<!--slider area start-->
<div class="slider_area slider_four slider_five">
...
<!--about section area -->
<?php while($crow = mysqli_fetch_array($nquery3)){ ?>
<div class="about_section">
    <div class="container">   
        <div class="row align-items-center">
            <div class="col-lg-6 col-md-12">
                <div class="about_thumb">
                    <img src="uploads/<?php echo $crow['home_img'] ?>" alt="about us">
                </div>
            </div>
            <div class="col-lg-6 col-md-12">
        ...
        <div class="row">
            <div class="col-12">
                <div class="services_title">
                    <h2 style="font-size: 35px;font-weight: 900;">Choose Top Selling Plan</h2>
                </div>
            </div>
        </div>
        <div class="row">
            <?php while($crow = mysqli_fetch_array($nquery7)){ ?>
            <div class="col-lg-3 col-md-6">
                <div class="single_priceing">
                    <?php echo $crow['content'] ?> 
                    <a class="list_button" href="#">subscribe now</a>     
                </div>
            </div>
            <?php } ?>
        </div>
            ...
            <div class="col-lg-6 col-md-6">
                <div class="unlimited_services_content">
                    ...
                    <div class="view__work">
                        <a href="why-maury-broadband.php"><i class="fa fa-angle-right"></i> MORE INFO</a>
                    </div>  
                </div>
            </div>
            <?php } ?>
...
<!--banner section area--> 
<?php while($crow = mysqli_fetch_array($nquery5)){ ?>
<div class="banner_section_bg" style="background-image: url(uploads/<?php echo $crow['home_img'] ?>);">
    <div class="banner_bg_content">
       <?php echo $crow['content'] ?>
       <a href="residential.php"><i class="fa fa-angle-right"></i> Learn More</a>
    </div>
</div>
<?php } ?>
<!--banner section end-->
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="blog_active owl-carousel">
                <?php while($crow = mysqli_fetch_array($nquery6)){ ?>
                <div class="col-lg-4">
                    <div class="single_blog">
                        <div class="blog_thumb">
                            <a href="blog-details.php?blog_id=<?php echo strtolower(str_replace(" ", "-", $crow['url']));?>"><img src="uploads/<?php echo $crow['photo'] ?>" alt="<?php echo $crow['title'] ?>"></a>
                        </div>
                        <div class="blog_content">
                            <div class="blog_title">
                                <h3><a href="blog-details.php?blog_id=<?php echo strtolower(str_replace(" ", "-", $crow['url']));?>"><?php echo $crow['title'] ?></a></h3>
                            </div>
                            <div class="blog_meta">
                                <i class="fa-calendar fa"></i>
                                <span class="post_date"><?php echo $crow['date'] ?></span>
                            </div>
                            <div class="blog_desc">
                                <?php echo $crow['content'] ?>
                            </div>
...
<div class="contact_map">
    <div class="map-area">
        <iframe frameborder="0" style="width:100%;height:460px;" src="https://www.google.com/maps/embed/v1/place?key=AIzaSyA0Dx_boXQiwvdz8sJHoYeZNVTdoWONYkU&amp;q=Golf+Link+Residency" allowfullscreen=""></iframe>
    </div>
</div>
<!--contact map end-->
