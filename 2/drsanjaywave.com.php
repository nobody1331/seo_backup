...
?>
<?php 
    $nquery=mysqli_query($conn,"select * from `banner` where type='Banner' ORDER BY banner_id ASC"); 
    $nquery2=mysqli_query($conn,"select * from `banner` where type='Gallery' ORDER BY banner_id ASC limit 8");
    // $nquery3=mysqli_query($conn,"select * from `about` where type='about1' ORDER BY about_id ASC limit 1");
    $nquery4=mysqli_query($conn,"select * from `about` where type='about2' ORDER BY about_id ASC limit 1");
    $nquery5=mysqli_query($conn,"select * from `video` where type='Events' ORDER BY video_id ASC limit 4");
    $nquery8=mysqli_query($conn,"select * from `video` where type='Bulletin' ORDER BY video_id ASC limit 4");
    $nquery6=mysqli_query($conn,"select * from `video` where type='Youtube' ORDER BY video_id ASC limit 4");
    $nquery7=mysqli_query($conn,"select * from `course` ORDER BY course_id ASC limit 4");
?>

<?php
    $nquery8=mysqli_query($conn,"select * from `social` ORDER BY social_id ASC");
    $crow8 = mysqli_fetch_array($nquery8);
?>
<?php
    $nquery9=mysqli_query($conn,"select * from `bulletin` where type='Bulletin' ORDER BY bulletin_id ASC");
    $crow9 = mysqli_fetch_array($nquery9);
    $nquery10=mysqli_query($conn,"select * from `bulletin` where type='Monthly' AND status='Lite' ORDER BY bulletin_id ASC");
    $crow10 = mysqli_fetch_array($nquery10);
    $nquery11=mysqli_query($conn,"select * from `bulletin` where type='Monthly' AND status='Premium' ORDER BY bulletin_id ASC");
    $crow11 = mysqli_fetch_array($nquery11);
    $nquery12=mysqli_query($conn,"select * from `bulletin` where type='Quartely' AND status='Lite' ORDER BY bulletin_id ASC");
    $crow12 = mysqli_fetch_array($nquery12);
    $nquery13=mysqli_query($conn,"select * from `bulletin` where type='Quartely' AND status='Premium' ORDER BY bulletin_id ASC");
    $crow13 = mysqli_fetch_array($nquery13);
    $nquery14=mysqli_query($conn,"select * from `bulletin` where type='HalfYearly' AND status='Lite' ORDER BY bulletin_id ASC");
    $crow14 = mysqli_fetch_array($nquery14);
    $nquery15=mysqli_query($conn,"select * from `bulletin` where type='HalfYearly' AND status='Premium' ORDER BY bulletin_id ASC");
    $crow15 = mysqli_fetch_array($nquery15);
    $nquery16=mysqli_query($conn,"select * from `bulletin` where type='Yearly' AND status='Lite' ORDER BY bulletin_id ASC");
    $crow16 = mysqli_fetch_array($nquery16);
    $nquery17=mysqli_query($conn,"select * from `bulletin` where type='Yearly' AND status='Premium' ORDER BY bulletin_id ASC");
    $crow17 = mysqli_fetch_array($nquery17);
?>
<?php
    $nquery18=mysqli_query($conn,"select * from `calculator` where type='Calculator' ORDER BY calculator_id ASC");
    $crow18 = mysqli_fetch_array($nquery18);
    $nquery19=mysqli_query($conn,"select * from `calculator` where type='Monthly' ORDER BY calculator_id ASC");
    $crow19 = mysqli_fetch_array($nquery19);
    $nquery20=mysqli_query($conn,"select * from `calculator` where type='Quartely' ORDER BY calculator_id ASC");
    $crow20 = mysqli_fetch_array($nquery20);
    $nquery21=mysqli_query($conn,"select * from `calculator` where type='HalfYearly' ORDER BY calculator_id ASC");
    $crow21 = mysqli_fetch_array($nquery21);
    $nquery22=mysqli_query($conn,"select * from `calculator` where type='Yearly' ORDER BY calculator_id ASC");
    $crow22 = mysqli_fetch_array($nquery22);
    $nquery23=mysqli_query($conn,"select * from `cms_pages` where type='Testimonial' ORDER BY cms_id ASC");
?>

<!--slider area start-->
<div class="slider_area slider_four slider_five pb-0">
	<div class="slider_active owl-carousel">
        <?php while($crow = mysqli_fetch_array($nquery)){ ?>
            <div class="single_product_gallery">
                <img src="uploads/<?php echo $crow['banner_img'] ?>" alt="<?php echo $crow['banner_name'] ?>">
            </div>
        <?php } ?>
	</div>
</div> 
...
<!--about section area -->
<?php while($crow = mysqli_fetch_array($nquery4)){ ?>
<div class="about_section">
    <div class="container">   
        <div class="row align-items-center">
            <div class="col-lg-6 col-md-12">
                <div class="about_thumb">
                    <img src="uploads/<?php echo $crow['about_img'] ?>" alt="about us">
                </div>
            </div>
            <div class="col-lg-6 col-md-12">
...
<div class="our_services">
    <div class="container">   
        ...
        <div class="row">
            <?php while($row = mysqli_fetch_array($nquery7)){ ?>
            <div class="col-lg-6 col-12">
                <div class="services_item row">
                     <div class="services_icone col-md-5">
                        <img src="updates/<?php echo $row['course_img'] ?>" alt="our course">
                    </div>
                    <div class="services_desc col-md-7">
                        <div class="content">
                            <?php echo $row['content'] ?>
                        </div>
                        <a href="course-details.php?course_id=<?php echo strtolower(str_replace(" ", "-", $row['url']));?>">Read More..</a>
                    </div>  
                </div>
            </div>
            <?php } ?>
...
<div class="portfolio_section_area">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="services_title">
                    <h2>Dr. Sanjay Wave Bulletin</h2>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-5">
                <div class="text-center"><h3 style="color: #00053b;">Subscription Plans</h3></div>
                <ul class="nav nav-pills mb-3 text-center" id="pills-tab" role="tablist">
                  ...
                  <li class="nav-item col-3 p-0" role="presentation">
                    <a class="nav-link" id="quartely-tab" data-toggle="pill" href="#quartely" role="tab" aria-controls="quartely" aria-selected="false">Quaterly</a>
                  </li>
                  <li class="nav-item col-3 p-0" role="presentation">
                    <a class="nav-link" id="halfyearly-tab" data-toggle="pill" href="#halfyearly" role="tab" aria-controls="halfyearly" aria-selected="false">Half Yearly</a>
                  </li>
                  <li class="nav-item col-3 p-0" role="presentation">
            ...
            <div class="col-md-7">
                <div class="tab-content" id="pills-tabContent">
                  <div class="tab-pane fade show active" id="monthly" role="tabpanel" aria-labelledby="monthly-tab">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 gird_item">
                            <div class="single_priceing">
                                <?php echo $crow10['content'] ?>
                                <a class="list_button" href="<?php echo $crow8['android'] ?>">Download App</a>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 gird_item">
                            <div class="single_priceing">
                                <?php echo $crow11['content'] ?> 
                                <a class="list_button" href="<?php echo $crow8['android'] ?>">Download App</a>  
                            </div>
                        </div>
                    </div>
                  </div>
                  <div class="tab-pane fade" id="quartely" role="tabpanel" aria-labelledby="quartely-tab">
                    <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="single_priceing">
                            <?php echo $crow12['content'] ?>   
                            <a class="list_button" href="<?php echo $crow8['android'] ?>">Download App</a>
                        </div>
                    </div>
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="single_priceing">
                                <?php echo $crow13['content'] ?>  
                                <a class="list_button" href="<?php echo $crow8['android'] ?>">Download App</a>  
                            </div>
                        </div>
                    </div>
                </div>
                <div class="tab-pane fade" id="halfyearly" role="tabpanel" aria-labelledby="halfyearly-tab">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="single_priceing">
                                <?php echo $crow14['content'] ?>    
                                <a class="list_button" href="<?php echo $crow8['android'] ?>">Download App</a>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="single_priceing">
                                <?php echo $crow15['content'] ?>
                                <a class="list_button" href="<?php echo $crow8['android'] ?>">Download App</a>  
                            </div>
                        </div>
                    </div>
                ...
                <div class="tab-pane fade" id="yearly" role="tabpanel" aria-labelledby="yearly-tab">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="single_priceing">
                                <?php echo $crow16['content'] ?>  
                                <a class="list_button" href="<?php echo $crow8['android'] ?>">Download App</a>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="single_priceing">
                                <?php echo $crow17['content'] ?>  
                                <a class="list_button" href="<?php echo $crow8['android'] ?>">Download App</a>  
                            </div>
                        </div>
                    </div>
...
<div class="portfolio_section_area">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="services_title">
                    <h2>Dr. Sanjay Wave Calculator</h2>
                </div>
            </div>
        </div>
        <div class="row calculator">
            <div class="col-md-7">
                ...
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                  <li class="nav-item col-3 p-0" role="presentation">
                    <a class="nav-link active" id="monthly2-tab" data-toggle="pill" href="#monthly2" role="tab" aria-controls="monthly2" aria-selected="true">Monthly</a>
                  </li>
                  <li class="nav-item col-3 p-0" role="presentation">
                    <a class="nav-link" id="quartely2-tab" data-toggle="pill" href="#quartely2" role="tab" aria-controls="quartely2" aria-selected="false">Quaterly</a>
                  </li>
                  <li class="nav-item col-3 p-0" role="presentation">
                    <a class="nav-link" id="halfyearly2-tab" data-toggle="pill" href="#halfyearly2" role="tab" aria-controls="halfyearly2" aria-selected="false">Half Yearly</a>
                  </li>
                  <li class="nav-item col-3 p-0" role="presentation">
                    <a class="nav-link" id="yearly2-tab" data-toggle="pill" href="#yearly2" role="tab" aria-controls="yearly2" aria-selected="false">Yearly</a>
                  </li>
                </ul>
                <div class="headercontent">
                    <?php echo $crow18['content'] ?>
                </div>
            </div>
            <div class="col-md-5">
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="monthly2" role="tabpanel" aria-labelledby="monthly2-tab">
                        <div class="single_priceing">
                            <?php echo $crow19['content'] ?>
                            <a class="list_button" href="<?php echo $crow8['android'] ?>">Download App</a>   
                        </div>
                      </div>
                      <div class="tab-pane fade" id="quartely2" role="tabpanel" aria-labelledby="quartely2-tab">
                        <div class="single_priceing">
                            <?php echo $crow20['content'] ?>
                            <a class="list_button" href="<?php echo $crow8['android'] ?>">Download App</a>   
                        </div>
                    </div>
                    <div class="tab-pane fade" id="halfyearly2" role="tabpanel" aria-labelledby="halfyearly2-tab">
                        <div class="single_priceing">
                            <?php echo $crow21['content'] ?>
                            <a class="list_button" href="<?php echo $crow8['android'] ?>">Download App</a>
                        </div>       
                    </div>
                    <div class="tab-pane fade" id="yearly2" role="tabpanel" aria-labelledby="yearly2-tab">
                        <div class="single_priceing">
                            <?php echo $crow22['content'] ?>
                            <a class="list_button" href="<?php echo $crow8['android'] ?>">Download App</a>  
                        </div>
                    </div>
                </div>
...
<div class="portfolio_section_area">
    <div class="container">
        ...
        <div class="row">
            <?php while($row = mysqli_fetch_array($nquery6)){ ?>
            <div class="col-lg-3 col-md-4 col-sm-6 gird_item">
                <iframe width="100%" height="200" src="https://www.youtube.com/embed/<?php echo $row['code'] ?>" title="<?php echo $row['title'] ?>" frameborder="0"></iframe>
            </div>
            <?php } ?>
        </div>
    </div>
...
<div class="portfolio_section_area">
    <div class="container">
        ...
        <div class="row">
            <?php while($row = mysqli_fetch_array($nquery5)){ ?>
            <div class="col-lg-3 col-md-4 col-sm-6 gird_item">
                <iframe width="100%" height="200" src="https://www.youtube.com/embed/<?php echo $row['code'] ?>" title="<?php echo $row['title'] ?>" frameborder="0"></iframe>
            </div>
            <?php } ?>
...
<div class="portfolio_section_area">
    <div class="container-fluid">
        ...
        <div class="row">
            <?php while($crow = mysqli_fetch_array($nquery2)){ ?>
            <div class="col-lg-3 col-md-4 col-sm-6 gird_item">
                <div class="single_portfolio_inner">
                    <div class="portfolio_thumb">
                        <a href="#"><img src="uploads/<?php echo $crow['banner_img'] ?>" alt=""></a>
                        <div class="portfolio_popup">
                            <a class="port_popup" href="uploads/<?php echo $crow['banner_img'] ?>"><i class="fa fa-eye"></i></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="text-center"><a class="btn btn-primary" href="gallery.php">View All</a></div>
    </div>
</div>
<!--gallery section end-->
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="testimonial_active owl-carousel">
                <?php while($crow = mysqli_fetch_array($nquery23)){ ?>
                <div class="col-12">
                ...
                <!-- <div class="col-12">
                    <div class="single_testimonial">
                        <p><i class="fa fa-quote-left"></i> These guys have been absolutely outstanding. Perfect Themes and the best of all that you have many options to choose! Best Support team ever! Very fast responding! Thank you very much! I highly recommend this theme and these people! <i class="fa fa-quote-right"></i> </p>
