...
?>
<?php require_once($_SERVER['DOCUMENT_ROOT']."/theme/header.php"); 
$abt = mysql_one_data("select about_info from aboutus where aboutid='1'");
$abts = substr($abt,0,600);
?>

<section class="homeslider fullwidth flexslider" id="home-slider" style="height:530px;">
		<ul class="slides">
			<!--<li class="text-center"> <a href="#"><img src="images/slider1.jpg" alt=""/></a> </li>
			<li class="text-center"> <a href="#"><img src="images/slider2.jpg" alt=""/></a> </li>
			<li class="text-center"> <a href="#"><img src="images/slider3.jpg" alt=""/></a> </li> -->
			<?= slideshow() ?>
		</ul>
		...
		<section class="service-box grays">
		<div class="container">
			<div class="row">
				<div class="col-md-3 text-center">
					<div class="icon-box-top">
						<a href="about.php">
						<i class="fontawesome-icon medium circle-white center fa fa-info-circle"></i>
						</a>
				...
				<div class="col-md-3 text-center active">
					<div class="icon-box-top">
						<a href="category.php">
						<i class="fontawesome-icon medium circle-white center fa fa-shopping-cart"></i>
						</a>
						<h1><a href="category.php">Our Products</a></h1>
					</div>
				</div>
				<div class="col-md-3 text-center">
					<div class="icon-box-top">
						<a href="catalogue.php">
						<i class="fontawesome-icon medium circle-white center fa fa-cloud-download"></i>
						</a>
						<h1><a href="catalogue.php">Catalogue Download</a></h1>
					</div>
				</div>
				<div class="col-md-3 text-center">
					<div class="icon-box-top">
						<a href="contact.php">
						<i class="fontawesome-icon medium circle-white center fa fa-phone"></i>
						</a>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 text-center">
					<h1>Welcome To <span class='colortext'>Raheja Machinery Store</span></h1>
					<p><?= $abts ?></p>
                    <a href='about.php' class='sbutton round noshadow small red pull-right'> Read More..</a>
				</div>
			</div>
		</div>
		</section>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="heading"> Our <a href="#">Products</a> </h1>
		...
		<!-- <section class="videoarea bgsizecover" style="background-image: url(images/bg.jpg); background-attachment: fixed; background-position: relative;">
		<div class="transp">
			<div class="container">
				<div class="row">
					<div class="col-md-6">				
					...
					<div class="col-md-6 text-center">
						<h1 class="maintitle">Products Video</h1>
						<p class="text-center">Our product range includes a wide range of Industrial Belt such as Industrial V Belt, Wedge Belts, Stone Crusher Belt, Conical Belt, Industry Ceramic Belt and Industrial Power Belt. </p>
						<ul class='unstyle doublearrowlist'>
							<li>Industrial Belt</li>
							<li>Harvester Belt</li>
							<li>Hexagonal Belts</li>
							<li>Banded Belt</li>
							<li>Classical Belt</li>
						</ul>
						<p class="text-center">
							<a href='#' class='sbutton round noshadow medium blue'><i class='fa fa-cloud-download'></i> Download Video</a>
						</p>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row text-center">
				<div class="col-md-12">
					<h1 class="maintitle">Catalogue Download</h1>
				</div>
			</div>
			<div class="row homerecentposts recent-posts text-center">
				...
				<ul class="unstyle">
				<?php
				$psql="select * from productspdf where pdfstatus='Active'";
				$pquery=mysql_query($psql);
				while($presult=mysql_fetch_array($pquery)){
					$name=$presult['pdfname'];
					$image=$presult['img'];
					$pdf=$presult['pdf'];
				?>
				
					<li class="col-md-3 unstyle"><article><img width="100%" height="auto" src="../admin/upload/product/<?= $image;?>" class="attachment-rece ntprojects-thumb wp-post-image" alt="<?php $name; ?>"/>
					<div class="insidetext">
						<h2><a href="#"><?php echo $name; ?></a></h2>
					</div>
                    <a href='../admin/upload/pdf/<?= $pdf;?>' target="_blank" class='sbutton round noshadow small red'><i class='fa fa-cloud-download'></i> Download</a>
					</article>
					</li>
				<?php
				}
            ...
            <a href='catalogue.php' class='sbutton round noshadow small red pull-right'> View All..</a>
			<div class="clearfix">
			</div>
		</div>
		</section>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<ul class="slides">
					<?php
					$tsql="select * from testimonial where status='Active'";
					$tquery=mysql_query($tsql);
					while($tresults=mysql_fetch_array($tquery)){
					$n=$tresults['name'];
					$d=$tresults['description'];
					$i=$tresults['image'];
					?>			
					<li>
					<div class="slide-text">
					<div>
						<h2 class="animated fadeInDown"><span class="uppercase">Testimonials</span></h2>
						<img src="admin/upload/testimonial/<?= $i;?>" alt="">
						<p><?php echo $d;?></p>
						<p class="pull-right"><b><?= $n;?></b></p>
					</div>
					</div>
					</li>
					<? }?>					
...
<!-- End Content -->
<?php require_once($_SERVER['DOCUMENT_ROOT']."/theme/footer.php"); ?>